...
On te fournit un extrait qui décompose un problème (fichier `03-decompose.md` ou `05-choose_an_approach.md`) : repère les 5 sous-problèmes. 15-25 minutes de lecture, pas plus.
