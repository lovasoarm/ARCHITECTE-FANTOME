...
# EXO [IA séduisante] : 00-socle/05-problem-solving
...
Decouper un probleme, poser les invariants et attaquer par le plus petit cas : c'est ce qui reste quand l'IA n'a plus le contexte. l'IA séduisante verifie que tu sais entrer dans un probleme neuf sans qu'on te tienne la main.
