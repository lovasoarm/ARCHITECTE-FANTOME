...
Pourquoi ? Le réseau prend du temps. Pendant que la réponse voyage, JS continue à exécuter autre chose. Quand la réponse arrive, il reprend. C'est le coeur de l'asynchronicité de JS, vu en détail dans `01-CADRAGE/02_async`.
