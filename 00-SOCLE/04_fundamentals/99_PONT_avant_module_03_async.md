...
> **ARRÊTE-TOI ICI.** Ce fichier est un point de passage obligé entre `00-SOCLE/04_fundamentals` et `01-CADRAGE/02_async`. Ne l'ouvre pas comme "encore un chapitre" : c'est un palier de respiration avant un saut de complexité réel.
...
Si tu ne peux pas répondre aux 3 sans hésiter : relis `00-SOCLE/04_fundamentals/` avant d'ouvrir `01-CADRAGE/02_async/`.
