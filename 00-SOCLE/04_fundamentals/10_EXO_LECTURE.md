...
On te fournit un extrait 20-40 lignes mêlant closure, `this`, hoisting, coercion : issu de tes exercices ou d'un fichier de `00-SOCLE/04_fundamentals/`. 15-25 minutes de lecture, pas plus.
