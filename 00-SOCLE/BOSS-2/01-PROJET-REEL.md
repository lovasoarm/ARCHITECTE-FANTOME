...
[Boss 2 de 00-SOCLE](README.md)

# Projet reel : referentiel x fundamentals

## Ce que tu livres

- Aucun boss-fight n'existait pour ces deux modules. La commande : livre, sur ton projet fil rouge, un increment qui ne tient que si [referentiel](../03_referentiel/README.md) et [fundamentals](../04_fundamentals/README.md) tiennent ensemble. Un increment qui passe en n'utilisant qu'un seul des deux modules ne compte pas.
