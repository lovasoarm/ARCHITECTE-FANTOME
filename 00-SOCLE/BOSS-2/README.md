...
# Boss 2 de 00-SOCLE : referentiel x fundamentals

Ce Boss ferme les deux modules [referentiel](../03_referentiel/README.md) et [fundamentals](../04_fundamentals/README.md). Il n'enseigne rien : il verifie que les deux tiennent
