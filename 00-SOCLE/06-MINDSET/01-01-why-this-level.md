...
[01-PROBLEM-HUNT](../../01-CADRAGE/01-PROBLEM-HUNT/README.md). Il ne couvre pas non plus le découpage d'un projet
en tranches livrables, traité au [05-MVP-SPLIT](../../01-CADRAGE/05-MVP-SPLIT/README.md), ni la modélisation
fine des données, traitée au [08-DATA-SPELLS](../../02-CONSTRUCTION/08-DATA-SPELLS/README.md).
...
[08-DATA-SPELLS](../../02-CONSTRUCTION/08-DATA-SPELLS/README.md), à choisir une architecture qui limite le rayon de
casse au [15-ARCHI-LAB](../../02-CONSTRUCTION/15-ARCHI-LAB/README.md), et à écrire un contrat d'API qui n'autorise
pas de comportement ambigu au [20-API-DOJO](../../02-CONSTRUCTION/20-API-DOJO/README.md). Le chiffrage de coût de
décision revient tel quel dans l'estimation honnête du [05-MVP-SPLIT](../../01-CADRAGE/05-MVP-SPLIT/README.md).

## Analogie

Analogie : penser en ingénieur, c'est diagnostiquer aux urgences avant de traiter, et sonder le bois avant de scier.
Où l'analogie casse : aux urgences le patient dit où il a mal, ton système ne dit rien tant qu'il ne tombe pas.
