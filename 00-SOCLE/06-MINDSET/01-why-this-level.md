...
[niveau 02](../../01-CADRAGE/01-PROBLEM-HUNT/README.md). Il ne couvre pas non plus le découpage d'un projet
en tranches livrables, traité au [niveau 03](../../01-CADRAGE/05-MVP-SPLIT/README.md), ni la modélisation
fine des données, traitée au [niveau 05](../../02-CONSTRUCTION/08-DATA-SPELLS/README.md).
...
[niveau 05](../../02-CONSTRUCTION/08-DATA-SPELLS/README.md), à choisir une architecture qui limite le rayon de
casse au [niveau 06](../../02-CONSTRUCTION/15-ARCHI-LAB/README.md), et à écrire un contrat d'API qui n'autorise
pas de comportement ambigu au [niveau 07](../../02-CONSTRUCTION/20-API-DOJO/README.md). Le chiffrage de coût de
décision revient tel quel dans l'estimation honnête du [niveau 03](../../01-CADRAGE/05-MVP-SPLIT/README.md).
