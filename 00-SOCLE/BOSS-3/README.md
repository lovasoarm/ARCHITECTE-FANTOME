...
# Boss 3 de 00-SOCLE : problem solving x MINDSET

Ce Boss ferme les deux modules [problem solving](../05_problem_solving/README.md) et [MINDSET](../06-MINDSET/README.md). Il n'enseigne rien : il verifie que les deux tiennent
