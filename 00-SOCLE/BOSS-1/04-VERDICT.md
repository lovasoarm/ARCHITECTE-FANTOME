...
| Il mobilise reellement les deux modules [getting started](../01_getting_started/README.md) et [PROLOGUE](../02-PROLOGUE/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `00-SOCLE/BOSS-1 : PASSE le <date>`. Sans cette ligne, les deux
