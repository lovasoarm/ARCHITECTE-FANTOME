...
- Les conventions de nommage (numérotation continue 01 -> 32, préfixes,
  fichiers `00_why_*`, `00-PREREQUIS.md`, grimoires en 4 colonnes).
...
Chaque **module racine** (`00-SOCLE/04-FUNDAMENTALS`, `00-SOCLE/05-PROBLEM-SOLVING`, etc.)
a obligatoirement son `00_why_<module>.md`. Ça, c'est non négociable :
32/54 modules pédagogiques directs le respectent.
...
dans `00-SOCLE/04-FUNDAMENTALS` répond déjà à la question "pourquoi" via
`01A-00-why-fundamentals.md`).
