...
Cette implémentation en JavaScript est volontaire. Elle sera progressivement typée et migrée vers TypeScript dans le module `02-CONSTRUCTION/12-TYPESCRIPT`.
