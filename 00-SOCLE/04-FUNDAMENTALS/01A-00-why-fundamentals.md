...
Oui, sans discussion. Ce bloc fait partie des "6 blocs prioritaires" du curriculum pour une raison simple : tout le reste en dépend. `01-CADRAGE/02-ASYNC`, `02-CONSTRUCTION/06-DATA-STRUCTURES`, `02-CONSTRUCTION/09-FUNCTIONAL-JS` : chacun de ces modules suppose que tu maîtrises déjà closures, scope, types, fonctions. Sauter ce module, c'est construire un immeuble sans fondations et espérer que ça tienne au 5ème étage.
...
Maintenant, ouvre `03-intro_variables.md`. Et cette fois, regarde vraiment ce qui se passe en mémoire.
