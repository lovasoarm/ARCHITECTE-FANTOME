...
- Dans `data/projects.js`, écris un tableau de tes six projets (ZO, Hotelia, ce parcours, Safe-driving, RECIPLY, Lovasoa) avec au minimum `id`, `title`, `category`, `year`, `featured`.
