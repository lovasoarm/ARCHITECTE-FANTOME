...
- **7 jours sans progres** -> tu declenches `05-MAITRISE/06_annexes/16_career/03_plateau_playbook.md`.
...
- **Date** : AAAA-MM-JJ
- **Module en cours** : ex. `01-CADRAGE/02_async/04_event_loop`
...
- **Date** : 2026-03-08
- **Module** : `01-CADRAGE/02_async/04_event_loop`
...
- **Action** : j'ouvre `05-MAITRISE/06_annexes/16_career/03_plateau_playbook.md` et
