...
### Ligne hebdomadaire obligatoire : une PR externe lue et fichée

La lecture domine le premier mois en entreprise, et le parcours entraîne surtout à produire.
Cette ligne rétablit le ratio. Chaque semaine, une pull request externe lue et fichée, au
gabarit des 12 fiches de PR déjà exigées comme livrable du niveau. Dix lignes, quatre
questions :

```text
1. Quel probleme cette PR resout, formule sans jargon du projet
2. Quelle decision son auteur a prise, et quelle alternative il a ecartee
3. Qu'est-ce qui aurait casse si elle n'avait pas ete faite
4. Une chose que tu aurais faite differemment, avec son cout
```

Critère de réussite mesurable : 12 fiches datées, une par semaine, sur 12 dépôts différents,
dont au moins 4 dans un langage que tu ne pratiques pas. Ce dernier point transforme
l'exercice en preuve de transférabilité, et alimente directement `TRANSFERT.md`.
...
Analogie : une routine quotidienne, c'est la mise en place refaite chaque matin, et l'entraînement d'endurance avant une grande course.
Où l'analogie casse : la mise en place se voit dans le service du soir, ton entraînement de jugement ne se voit qu'au bout de plusieurs mois.
