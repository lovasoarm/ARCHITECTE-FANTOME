...
- Amont : `../../../01-CADRAGE/03-DEBUGGING/06-hypothesis_driven_debug.md` (formuler une hypothèse debug).
- Aval : `../../../03-PILOTAGE/10-TEAM-CRAFT/02-code_review.md` (recevoir et donner des retours).
