...
acte: comprendre
cognitive_level: L4
perturbation_modes: [temps_limite, constraints_injectees]
anti_recipe_key: temps_limite+constraints_injectees
...
Un apprenant qui termine ce parcours sans avoir simulé une défense orale découvrira cette compétence... en vrai entretien. Ce fichier existe pour que ça n'arrive pas.
...
1. Choisis une décision de ton portfolio (dans un `ADR/` de `02-CONSTRUCTION/02-MINI-PROJECTS/`).
2. Colle le consigne ci-dessous à une IA (ou à un binôme qui joue le rôle).
...
## consigne POUR L'IA (rôle recruteur hostile)
...
- **1 run par mini-projet terminé** (19 mini-projets = 19 simulations sur la durée du cursus).
