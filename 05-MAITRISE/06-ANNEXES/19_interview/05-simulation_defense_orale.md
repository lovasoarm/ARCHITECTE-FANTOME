...
`02-CONSTRUCTION/02-MINI-PROJECTS/14_system_design_lab/`) devant un CTO hostile. Il n'a pas
...
- Copie ta note dans `05-MAITRISE/06-ANNEXES/19_interview/JOURNAL.md` (crée le si absent).
