...
- `11-interview_arena.md` : 10 sujets d'entretien avec grilles d'auto-évaluation.
- `14-portfolio_publication.md` : publier proprement sur GitHub : README, licence, historique lisible.
- `06-career_pivot.md` : plan 30 jours pour pivoter vers Rust / Python / cloud.
- `05-when_not_to_code.md` : les cas où la meilleure ligne de code est celle qu'on n'écrit pas.
- `15-generate_portfolio_report.md` : compiler ADR + POSTMORTEM + Ledger en un dossier défendable.
- `04-finops_greenops.md` : le coût réel de ton code : euros et carbone.
...
- `05-when_not_to_code.md` : la meilleure ligne de code est celle qu'on n'écrit pas.
- `10-pitch_vs_reality.md` : comment défendre ton travail face à "l'IA fait pareil".
- `13-trade_off_arena.md` : décider en public, assumer.
- `06-career_pivot.md`, `09-legal_employability.md`, `07-dev_health.md` : le hors-code qui casse ou fait durer une carrière.
