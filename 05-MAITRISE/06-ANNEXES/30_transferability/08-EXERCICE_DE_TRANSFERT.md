...
| ------------------------------------- | -------------------------------- | ------------------ |
| 00-SOCLE/04-FUNDAMENTALS              | Closure + scope lexical          | Python ou Rust     |
| 01-CADRAGE/02-ASYNC                   | Event loop / microtask           | Pseudo-Rust ou Go  |
| 02-CONSTRUCTION/05-MEMORY-PERFORMANCE | Cycle de vie objet + retainer    | Java (GC roots)    |
| 02-CONSTRUCTION/06-DATA-STRUCTURES    | Hash map avec collision          | C ou Zig           |
...
Tu n'as pas droit à assistant de code ni à ChatGPT pour la réimplémentation elle-même. Tu peux
