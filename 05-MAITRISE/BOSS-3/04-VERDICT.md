...
[Boss 3 de 05-MAITRISE](README.md)
...
| Il mobilise reellement les deux modules [DAY TO LEGEND](../05-DAY-TO-LEGEND/README.md) et [annexes](../06_annexes/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `05-MAITRISE/BOSS-3 : PASSE le <date>`. Sans cette ligne, les deux
