...
Avantage : protection contre l'abus, contrôle des coûts (vu aussi dans `04-EPREUVE/04-BIG-APP-SNOOP/01_ai_workflow` pour les appels LLM qui coûtent cher).
...
```js
// Version naïve avec Redis (vu en détail dans 05-MAITRISE/01-DATABASES/04_redis_caching)
