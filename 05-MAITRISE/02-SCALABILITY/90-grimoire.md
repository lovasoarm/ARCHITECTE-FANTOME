...
> Rappel : ce grimoire simplifie via analogies. Lire d'abord [`../06-ANNEXES/91-18_GRIMOIRE_CODE_HONNEUR.md`](../06-ANNEXES/91-18_GRIMOIRE_CODE_HONNEUR.md).
...
Ce grimoire couvre tout le module `05-MAITRISE/02-SCALABILITY`. Pas juste un résumé : c'est ce qu'un dev DOIT savoir par cœur avant de toucher une archi qui doit scaler. Si un terme ici te paraît flou, retourne à la leçon correspondante avant d'avancer.
