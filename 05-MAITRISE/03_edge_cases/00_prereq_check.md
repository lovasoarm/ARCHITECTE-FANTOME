...
> Ces questions portent sur `03-PILOTAGE/10_team_craft`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `03-PILOTAGE/10_team_craft/`, ou à sa synthèse `15_team_grimoire.md`.
