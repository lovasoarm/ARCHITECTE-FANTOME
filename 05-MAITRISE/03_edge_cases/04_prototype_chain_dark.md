...
> **Prérequis :** ce fichier suppose que tu sais ce qu'est un prototype et comment fonctionne l'héritage en JS. Si ce n'est pas encore le cas, le cours complet est dans `02-CONSTRUCTION/17_oop_js/01_prototype_chain_raw.md`. Tu peux quand même lire ce qui suit avec le rappel express ci-dessous, mais le module 18 reste la référence pour les bases.
