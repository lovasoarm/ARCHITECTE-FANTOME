...
| Il mobilise reellement les deux modules [databases](../01_databases/README.md) et [scalability](../02_scalability/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `05-MAITRISE/BOSS-1 : PASSE le <date>`. Sans cette ligne, les deux
