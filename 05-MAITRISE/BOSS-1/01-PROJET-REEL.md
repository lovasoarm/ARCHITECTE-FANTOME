...
[Boss 1 de 05-MAITRISE](README.md)

# Projet reel : databases x scalability

## Ce que tu livres

- Aucun boss-fight n'existait pour ces deux modules. La commande : livre, sur ton projet fil rouge, un increment qui ne tient que si [databases](../01_databases/README.md) et [scalability](../02_scalability/README.md) tiennent ensemble. Un increment qui passe en n'utilisant qu'un seul des deux modules ne compte pas.
