...
# Boss 1 de 05-MAITRISE : databases x scalability

Ce Boss ferme les deux modules [databases](../01_databases/README.md) et [scalability](../02_scalability/README.md). Il n'enseigne rien : il verifie que les deux tiennent
