...
Le piège classique, le problème N+1 (vu aussi en algo de complexité dans `02-CONSTRUCTION/05-MEMORY-PERFORMANCE/03_complexity`) :
...
Le pourquoi : ton schéma de DB est aussi important que ton code, donc il doit suivre la même discipline (vu dans `03-PILOTAGE/10-TEAM-CRAFT` pour la rigueur d'équipe) : versionné, reviewé, appliqué dans un ordre connu, jamais modifié à la main directement en prod.
