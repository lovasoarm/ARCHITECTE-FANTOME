...
Ce niveau n'a pas de `96-boss-fight.md` (voir [README.md](README.md), section « Écart au
gabarit »). La section `## Comportements évalués en boss-fight` exigée par
le gabarit du dépôt est donc portée par la colonne « Ce que tu dois savoir défendre » du
tableau ci-dessus, et par les critères de [95-challenge.md](95-challenge.md).
