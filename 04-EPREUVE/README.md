...
- Condition d'entree au capstone : `PORTAGE.md` existe physiquement, ses tests de contrat
  ...
  ([07_releve_tarifaire_reel.md](../03-PILOTAGE/07_cloud_foundations/07_releve_tarifaire_reel.md)).
...
Liste generee : tout fichier de `04-EPREUVE` est joignable depuis ici, aucun document n'est laisse sans porte d'entree.

- [RETRO-BLOC-4-EPREUVE.md](RETRO-BLOC-4-EPREUVE.md)
