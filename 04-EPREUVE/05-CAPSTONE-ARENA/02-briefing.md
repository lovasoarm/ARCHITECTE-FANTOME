...
J+12 (pendant le jalon Architecture)  : voir 05-changement-de-spec.md
                                         ...
                                         recurrents
J+24 (apres le jalon Architecture)    : voir 96-boss-fight.md
...
toi-même dans ton `05-TDD-JOURNAL.md` avec la même rigueur que les deux premières.
...
Ce n'est pas un exercice de style. La qualité de ton découpage dans `95-challenge.md` dépendra
