...
Jalon 2 : Architecture        8 h   seuil >= 12/20
   ...
   v
Jalon 3 : V1 et preuve       20 h   seuil >= 60/100, soit 204/340 (grille complète,
                                            04-evaluation-grid.md)
```
...
- Version 1 fonctionnelle (Livrable 3), dossier de suite (Livrable 4), auto-évaluation
  ...
  du module `04-EPREUVE/01-BONUS-VAULT` (`REVUE-DE-RISQUES.md`).

### Grille du jalon

La grille complète de `04-evaluation-grid.md` s'applique ici, sur son total de 340 points
(17 critères notés, dont les quatre exigences Staff : budget cloud, SLO/RTO, note de
direction, refus chiffré). Le seuil de 60/100 ci-dessous se lit donc 204/340.
...
20 h de V1 et preuve. Fourchette acceptable annoncée dans [04A-CARTE-DU-PARCOURS.md](../../06-ANNEXES-TRANSVERSES/04A-CARTE-DU-PARCOURS.md) :
25 à 40 h. Au-delà de 40 h, le problème n'est pas ta vitesse : c'est ton périmètre, et le
05-MVP-SPLIT t'a donné les ciseaux.
