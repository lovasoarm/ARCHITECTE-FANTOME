...
# criteres : verification_pack de ai native dev
...
([README](../../../06-ANNEXES-TRANSVERSES/03-TECH-ILA/README.md)). Ce module porte son jalon 6 sur 6. Le jalon precede les trois drills
et ne se compense pas.

| Verification | Portee | Verdict |
| --- | --- | --- |
| Jalon 6 TECH-ILA franchi | [Niveau 6 : IA](../../../06-ANNEXES-TRANSVERSES/03-TECH-ILA/tech-ila/06-niveau-6-ia.md) | Jalon non franchi = **module non valide**, meme avec trois drills REUSSI |

Niveau attendu, binaire : une sortie de modele refusee par toi, avec la regle de refus ecrite avant de la lire.

Trace exigee : une ligne datee dans ton depot, `TECH-ILA jalon 6 franchi le <date> : <chemin de l'artefact>`.
