...
> Ces questions portent sur `03-PILOTAGE/04_security`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `03-PILOTAGE/04_security/`, ou à sa synthèse `07_security_grimoire.md`.
