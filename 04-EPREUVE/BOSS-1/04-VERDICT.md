...
[Boss 1 de 04-EPREUVE](README.md)
...
| Il mobilise reellement les deux modules [BONUS VAULT](../01-BONUS-VAULT/README.md) et [TOOL CAVE](../02-TOOL-CAVE/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `04-EPREUVE/BOSS-1 : PASSE le <date>`. Sans cette ligne, les deux
