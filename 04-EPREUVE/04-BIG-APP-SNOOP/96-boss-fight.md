...
```text
CONTRAINTE DE TEMPS
Reflexion + reponse ecrite : 45 min chrono
Au-dela : tu notes ou tu en etais a 45 min, et tu evalues CETTE
...
Ce Boss juge les modules `04-BIG-APP-SNOOP` ensemble. Il se passe une fois, sur artefact.
