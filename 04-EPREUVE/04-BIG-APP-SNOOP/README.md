...
[Sommaire](../../06-ANNEXES-TRANSVERSES/04A-CARTE-DU-PARCOURS.md) | [Niveau précédent](../../03-PILOTAGE/09-TEAM-QUEST/README.md) | [Niveau suivant](../05-CAPSTONE-ARENA/README.md)

# Module 04-EPREUVE/04-BIG-APP-SNOOP : Big App Snoop
...
[le grimoire du niveau précédent](../../03-PILOTAGE/09-TEAM-QUEST/90-grimoire.md) (20 minutes), puis refais son
[challenge](../../03-PILOTAGE/09-TEAM-QUEST/95-challenge.md) si deux réponses sur trois manquent. Entrer ici avec un
trou amont, c'est attribuer au module `04-EPREUVE/04-BIG-APP-SNOOP` une difficulté qui vient du module `03-PILOTAGE/09-TEAM-QUEST`.
...
Prérequis : Module `02-CONSTRUCTION/15-ARCHI-LAB` (Archi Lab) et 07 (API Dojo) terminés. Tu dois savoir reconnaître une
...
```text
11-BIG-APP-SNOOP/
+-- 01-01-why-this-level.md            -> pourquoi lire du code est une competence a part
...
+-- 95-challenge.md                    -> carte puis patch sur un vrai depot open source
+-- 96-boss-fight.md                   -> archeologie de code + grille d'evaluation chiffree
\-- 90-grimoire.md                     -> memo dense au format 4 colonnes
```

Fichiers du niveau : [01-01-why-this-level.md](01-01-why-this-level.md),
...
[05-modifier-sans-casser.md](05-modifier-sans-casser.md), [95-challenge.md](95-challenge.md),
[96-boss-fight.md](96-boss-fight.md), [90-grimoire.md](90-grimoire.md).
...
[95-challenge.md](95-challenge.md) te demande de refaire l'exercice complet, seul, sur un dépôt
...
- [Auto-test d'entrée : `04-BIG-APP-SNOOP`](00-PREREQUIS.md)
- [Pourquoi ce niveau existe](01-01-why-this-level.md)
- [Lire un code base en 3 heures](02-read-a-codebase.md)
- [Deviner les contraintes derrière un design](03-reverse-engineer-decisions.md)
- [Trois études de cas](04-case-studies.md)
- [Modifier sans casser](05-modifier-sans-casser.md)
- [Boss Fight : Le code moche avait une raison](96-boss-fight.md)
- [Challenge : Autopsie et modification d'un dépôt inconnu](95-challenge.md)
- [Grimoire : Big App Snoop](90-grimoire.md)
