...
> **Note** : cette section anticipe des concepts traités en détail dans `05-MAITRISE/02-SCALABILITY`.
...
C'est exactement ce que couvre `05-MAITRISE/02-SCALABILITY/08-message_queues.md`.
