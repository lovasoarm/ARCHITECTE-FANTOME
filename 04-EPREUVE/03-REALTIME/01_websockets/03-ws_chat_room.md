...
> Si tu n'as pas encore fait `02-CONSTRUCTION/13-RUNTIME-ENV/06_node_cli_scripts/03-filesystem_ops.md`, lis au minimum la section sur `readFile` et `writeFile` avant de commencer.
