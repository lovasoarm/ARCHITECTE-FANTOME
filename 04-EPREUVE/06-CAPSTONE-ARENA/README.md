...
[le grimoire du niveau précédent](../05-BIG-APP-SNOOP/grimoire.md) (20 minutes), puis refais son
...
```text
12-CAPSTONE-ARENA/
|-- 01-why-this-level.md      --> pourquoi un brief ambigu est un test, pas un défaut
...
[SCELLE-message-client-jalon-2.md](SCELLE-message-client-jalon-2.md) est volontairement
...
seul livrable évalué sur 260 points devant une grille complète : trois questions ne couvrent
