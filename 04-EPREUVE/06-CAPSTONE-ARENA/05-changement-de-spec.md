...
**N'ouvre pas [`SCELLE-message-client-jalon-2.md`](SCELLE-message-client-jalon-2.md)
...
`TDD_JOURNAL.md` une entrée horodatée avant d'ouvrir l'enveloppe scellée, par exemple :
...
[`SCELLE-message-client-jalon-2.md`](SCELLE-message-client-jalon-2.md) pour
