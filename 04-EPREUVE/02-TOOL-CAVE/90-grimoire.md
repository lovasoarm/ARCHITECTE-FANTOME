...
# Grimoire : Module 04-EPREUVE/02-TOOL-CAVE, Tool Cave
...
| Hypothèse silencieuse d'une réponse IA   | Tu livres un code qui répond à ta question mais pas à ton besoin réel                           | Comment repères-tu qu'un consigne était sous-spécifié après coup ?                                  |
...
## consigne de décision : patron réutilisable
...
redescends au 20-API-DOJO relire "idempotence" : une relance de lot mal maîtrisée cache souvent
