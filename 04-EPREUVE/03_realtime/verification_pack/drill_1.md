...
# drill_1 : restituer sans support : realtime
...
1. WebSocket
2. SSE (Server-Sent Events : événements envoyés par le serveur)
3. WebRTC (Web Real-Time Communication : communication web en temps réel)
4. Handshake (poignée de main protocolaire)
5. readyState (état courant de la connexion)
