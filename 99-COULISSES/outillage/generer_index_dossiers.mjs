...
// node 99-COULISSES/outillage/generer_index_dossiers.mjs [racine]
import { readFileSync, writeFileSync, readdirSync, existsSync } from "node:fs";
import { join } from "node:path";
import { IGNORE, listerFichiers } from "./lib_depot.mjs";

const racine = process.argv[2] ?? ".";
const DEBUT = "<!-- CONTENU-DOSSIER:debut (genere par 99-COULISSES/outillage/generer_index_dossiers.mjs) -->";
