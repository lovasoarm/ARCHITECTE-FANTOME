...
Le truc : JavaScript est single-threaded. Une seule chose à la fois. Quand t'as une opération lente : lire un fichier, faire une requête HTTP, attendre une réponse : tu peux pas juste bloquer et attendre. T'as besoin de dire au runtime : _fais ça, et quand c'est fini, appelle cette fonction_.
