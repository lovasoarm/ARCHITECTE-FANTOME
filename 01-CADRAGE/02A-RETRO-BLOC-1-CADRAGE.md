...
# Rétrospective de bloc : Bloc CADRAGE (01-CADRAGE, modules `01-PROBLEM-HUNT` a `05-MVP-SPLIT`)
...
Durée : 60 à 90 minutes. À faire après le boss-fight du 05-MVP-SPLIT, avant d'ouvrir le bloc
...
- ton cahier de problème du 01-PROBLEM-HUNT ([95-challenge.md](01-PROBLEM-HUNT/95-challenge.md)),
- ta liste de non-objectifs du 01-PROBLEM-HUNT,
- ton découpage en tranches du 05-MVP-SPLIT ([95-challenge.md](05-MVP-SPLIT/95-challenge.md)).
...
Crée le fichier `RETRO-BLOC-1-CADRAGE-<date-du-jour>.md` dans le dépôt de ton projet fil rouge.
...
| ------------------------------------------ | -------------------------------------------------------------------------------- |
| Un non-objectif est devenu un objectif     | Tu l'as ajouté sans jamais réécrire la ligne qui disait que tu ne le ferais pas. |
| Une métrique de succès n'est pas mesurable | Tu ne sais toujours pas où lire le chiffre, donc elle est décorative.            |
| La tranche 1 a grossi                      | Elle contient maintenant deux parcours utilisateur, pas un.                      |
...
Rouvre [95-challenge.md](01-PROBLEM-HUNT/95-challenge.md) et relis seulement sa section de critères de réussite : la plupart
...
Cette rétrospective **est** le Boss de palier : elle ferme le palier `01-CADRAGE`. Tant qu'elle n'est pas passée, le palier suivant reste fermé, même si tous les fichiers sont lus.
