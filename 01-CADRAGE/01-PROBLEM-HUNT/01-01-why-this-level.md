...
le rôle du [05-MVP-SPLIT](../05-MVP-SPLIT/README.md). Il ne couvre pas non plus comment traduire
ce besoin en parcours utilisateur détaillé, traité au [01-USER-WIZARD](../../02-CONSTRUCTION/01-USER-WIZARD/README.md).
...
Avoir suivi le [01-CADRAGE](../../00-SOCLE/06-MINDSET/README.md) : sans le réflexe de rendre les
...
au [05-MVP-SPLIT](../05-MVP-SPLIT/README.md). Les métriques de succès définies ici servent de
critère de validation dans les boss-fights des niveaux suivants, notamment au
[module `03-PILOTAGE/01-ROADMAP-RUN`](../../03-PILOTAGE/01-ROADMAP-RUN/README.md) pour suivre l'avancement réel d'un projet.
