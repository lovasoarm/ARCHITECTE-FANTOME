...
le rôle du [niveau 03](../05-MVP-SPLIT/README.md). Il ne couvre pas non plus comment traduire
ce besoin en parcours utilisateur détaillé, traité au [niveau 04](../../02-CONSTRUCTION/01-USER-WIZARD/README.md).
...
Avoir suivi le [niveau 01](../../00-SOCLE/06-MINDSET/README.md) : sans le réflexe de rendre les
...
au [niveau 03](../05-MVP-SPLIT/README.md). Les métriques de succès définies ici servent de
critère de validation dans les boss-fights des niveaux suivants, notamment au
[niveau 08](../../03-PILOTAGE/01-ROADMAP-RUN/README.md) pour suivre l'avancement réel d'un projet.
