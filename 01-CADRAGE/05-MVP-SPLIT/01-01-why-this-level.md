...
[01-PROBLEM-HUNT](../01-PROBLEM-HUNT/README.md), qui doit être traité avant. Il ne couvre pas non
plus le suivi de l'avancement réel une fois les tranches définies, traité au
[module `03-PILOTAGE/01-ROADMAP-RUN`](../../03-PILOTAGE/01-ROADMAP-RUN/README.md).
...
[01-PROBLEM-HUNT](../01-PROBLEM-HUNT/README.md). Découper un projet dont on ne sait pas encore ce
...
[module `03-PILOTAGE/01-ROADMAP-RUN`](../../03-PILOTAGE/01-ROADMAP-RUN/README.md). La discipline de dire non à une fonctionnalité hors
tranche prépare directement la gestion de règles métier ajoutées trop tôt, traitée au
[15-ARCHI-LAB](../../02-CONSTRUCTION/15-ARCHI-LAB/README.md).
