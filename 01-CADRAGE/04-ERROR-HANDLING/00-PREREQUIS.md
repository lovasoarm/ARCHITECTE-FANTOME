...
> Ces questions portent sur `01-CADRAGE/03-DEBUGGING`, le module que tu viens de finir.
...
- **2 ou moins** : retour à `01-CADRAGE/03-DEBUGGING/`, ou à sa synthèse `_recall_05.md`.
