...
Voir [`HYPOTHESES_EXEMPLE_REPRO_DETERMINISTE.md`](14_HYPOTHESES_EXEMPLE_REPRO_DETERMINISTE.md) : un `HYPOTHESES.md` rempli sur ce même exercice. À ouvrir APRÈS ta propre tentative, pour calibrer.
