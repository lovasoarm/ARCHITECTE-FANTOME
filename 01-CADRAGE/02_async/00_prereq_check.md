...
> Ces questions portent sur `00-SOCLE/05_problem_solving`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `00-SOCLE/05_problem_solving/`, ou à sa synthèse `_recall_05.md`.
