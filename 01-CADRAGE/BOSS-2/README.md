...
# Boss 2 de 01-CADRAGE : debugging x error handling

Ce Boss ferme les deux modules [debugging](../03_debugging/README.md) et [error handling](../04_error_handling/README.md). Il n'enseigne rien : il verifie que les deux tiennent
