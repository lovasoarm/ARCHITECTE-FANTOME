...
# Boss 3 de 03-PILOTAGE : observability x fiabilite slo

Ce Boss ferme les deux modules [observability](../05_observability/README.md) et [fiabilite slo](../06_fiabilite_slo/README.md). Il n'enseigne rien : il verifie que les deux tiennent
