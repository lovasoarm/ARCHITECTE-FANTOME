...
[Boss 3 de 03-PILOTAGE](README.md)
...
| Il mobilise reellement les deux modules [observability](../05_observability/README.md) et [fiabilite slo](../06_fiabilite_slo/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `03-PILOTAGE/BOSS-3 : PASSE le <date>`. Sans cette ligne, les deux
