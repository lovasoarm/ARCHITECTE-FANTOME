...
- L'architecture qui rend un système testable est posée en amont, dans
  [15-ARCHI-LAB/02-boundaries-and-coupling.md](../../02-CONSTRUCTION/15-ARCHI-LAB/02-boundaries-and-coupling.md).
- La gestion d'équipe autour d'un incident (communication au client, gestion du stress) est
  couverte par [09-TEAM-QUEST/04-communication-under-pressure.md](../09-TEAM-QUEST/04-communication-under-pressure.md).
- L'audit critique d'une réponse produite par une IA est traité dans
  02-TOOL-CAVE/97-audit-dune-reponse-verification.md.

## 7. Prérequis

- Savoir découper un système en modules avec des frontières claires (15-ARCHI-LAB).
...
02-TOOL-CAVE/97-audit-dune-reponse-verification.md pour
la méthode d'audit d'une suggestion produite par une IA.

## 14. Réutilisation dans les niveaux aval

- [11-BIG-APP-SNOOP](../../04-EPREUVE/04-BIG-APP-SNOOP/README.md) réutilise la lecture des tests existants
  comme méthode pour comprendre les intentions d'une base de code inconnue.
- [12-CAPSTONE-ARENA](../../04-EPREUVE/05-CAPSTONE-ARENA/README.md) exige un filet de sécurité minimal comme
