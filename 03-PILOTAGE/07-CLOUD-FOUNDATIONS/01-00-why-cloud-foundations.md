...
Porter un service d'un fournisseur à un autre force à séparer ce qui est _concept_ (une file, un
stockage d'objets, un calcul) de ce qui est _marque_. C'est exactement l'exercice que la famille S7
