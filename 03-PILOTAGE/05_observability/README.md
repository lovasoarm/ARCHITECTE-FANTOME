...
Liste generee : tout fichier de `03-PILOTAGE/05_observability` est joignable depuis ici, aucun document n'est laisse sans porte d'entree.

- [00_prereq_check.md](00_prereq_check.md)
- [00_why_observability.md](00_why_observability.md)
- [01_structured_logging.md](01_structured_logging.md)
- [01_structured_logging_minimini_projet.md](01_structured_logging_minimini_projet.md)
- [02_distributed_tracing.md](02_distributed_tracing.md)
- [03_tracing_paper_drill.md](03_tracing_paper_drill.md)
- [04_metrics_alerting.md](04_metrics_alerting.md)
- [05_sentry_in_prod.md](05_sentry_in_prod.md)
- [06_debug_in_prod.md](06_debug_in_prod.md)
