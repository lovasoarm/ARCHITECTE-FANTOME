...
- Node 22.23.2, zéro dépendance externe (ni `i18next` ni autre). L'idée est de comprendre le mécanisme, pas d'utiliser une lib.
...
Le script tourne, sort le JSON, exit code `0`. Si tu ne peux pas produire ce rapport en < 30 min, retourne à `02-i18n_basics.md`.
