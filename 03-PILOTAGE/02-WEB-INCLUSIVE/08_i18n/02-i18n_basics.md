...
acte: comprendre
cognitive_level: L3
perturbation_modes: [decision_inversee, regression]
anti_recipe_key: decision_inversee+regression
...
C'est le même principe que les modules de ce curriculum : tu ranges par dossier (`00-SOCLE/04-FUNDAMENTALS`, `01-CADRAGE/02-ASYNC`) plutôt que de tout balancer dans un seul fichier de 10 000 lignes.
