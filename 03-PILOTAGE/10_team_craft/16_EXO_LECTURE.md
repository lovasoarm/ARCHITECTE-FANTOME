...
On te fournit un extrait qui met en scène un code review / ADR / commit chirurgical : issu de `03-PILOTAGE/10_team_craft/01_code_review.md` ou `10_rfc_simulation.md`. 15-25 minutes de lecture, pas plus.
