...
[Boss 2 de 03-PILOTAGE](README.md)
...
| Il mobilise reellement les deux modules [QUALITY SHIELD](../03-QUALITY-SHIELD/README.md) et [security](../04_security/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `03-PILOTAGE/BOSS-2 : PASSE le <date>`. Sans cette ligne, les deux
