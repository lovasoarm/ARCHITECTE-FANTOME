## perishability_id: PER-0049

stability: perissable
acte: comprendre
cognitive_level: L3
perturbation_modes: [defaut_cache, decision_organisationnelle]
anti_recipe_key: defaut_cache+decision_organisationnelle
...
function onRedCard() {
  playersOnField--;
} // peut redescendre, contrairement au counter
function onSubstitution() {
  /* le nombre reste stable, mais peut varier en cas de blessure */
}
