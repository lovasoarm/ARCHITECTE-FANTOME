...
// avec des logs structurés (vus dans `03-PILOTAGE/05-OBSERVABILITY/01_structured_logging`)
...
```text
Une fuite mémoire (vue dans `02-CONSTRUCTION/05-MEMORY-PERFORMANCE/04_profiling`) progresse
