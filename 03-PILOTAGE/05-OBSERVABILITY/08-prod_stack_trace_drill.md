...
En architecture microservices, l'erreur que tu vois côté frontend n'est parfois que le symptôme d'un crash survenu trois services plus loin. Une stack trace seule ne le montre pas : il faut la croiser avec le `traceId` (module `03-PILOTAGE/05-OBSERVABILITY/02_distributed_tracing`).
