...
# Rétrospective de bloc : Bloc CONDUITE (de 03-PILOTAGE/01-ROADMAP-RUN a 03-PILOTAGE/11-LEADERSHIP-MENTORAT)
...
Durée : 60 à 90 minutes. À faire après le boss-fight du module `03-PILOTAGE/11-LEADERSHIP-MENTORAT`, avant d'ouvrir le bloc
...
Livrables ce parcours du palier :

- ton registre de risques ([95-challenge.md](01-ROADMAP-RUN/95-challenge.md)),
- ta stratégie de tests ([95-challenge.md](03-QUALITY-SHIELD/95-challenge.md)),
- ton working agreement ([95-challenge.md](09-TEAM-QUEST/95-challenge.md)).

Livrables **Staff** du même palier : sans eux la rétro ignore la moitié du niveau 3 :

- `SLO.md` et une injection de panne ([06-FIABILITE-SLO](06-FIABILITE-SLO/07-injection_panne.md)) ;
- `06A-BUDGET-CLOUD.md` à trois paliers ([07-CLOUD-FOUNDATIONS](./07-CLOUD-FOUNDATIONS/README.md)) ;
- `DECISION-ARBITRAGE.md` ([08-PRODUIT-COUT-ROI](./08-PRODUIT-COUT-ROI/README.md)) ;
- revue S5 + `STANDARDS-AGENTS.md` ([11-LEADERSHIP-MENTORAT](./11-LEADERSHIP-MENTORAT/README.md)).

Pour chacun des quatre : une ligne FAUX / INCOMPLET / TENU. Un palier « CONDUITE » qui ne
juge que ROADMAP / QUALITY / TEAM-QUEST n'est pas ce palier.
...
Rouvre [95-challenge.md](01-ROADMAP-RUN/95-challenge.md) et relis seulement sa section de critères de réussite : la plupart
...
Cette rétrospective **est** le Boss de palier : elle ferme le palier `03-PILOTAGE`. Tant qu'elle n'est pas passée, le palier suivant reste fermé, même si tous les fichiers sont lus.
