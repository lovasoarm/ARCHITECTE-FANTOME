...
# criteres : verification_pack de fiabilite et SLO
...
| --- | --- | --- |
| Aucun secret en clair | le document SLO, ses tableaux de bord et ses alertes livrees, plus tout extrait colle dans tes reponses de drill | Un seul secret en clair = **module non valide**, meme avec trois drills REUSSI |
