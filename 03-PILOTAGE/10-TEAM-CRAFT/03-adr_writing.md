...
Ce fichier est le **traitement de référence de l'ADR** dans ce dépôt : le gabarit ci-dessous
est le seul. Le choix entre ADR, RFC et one-pager : et les gabarits RFC et one-pager : sont
traités plus tard, dans
[04-EPREUVE/01-BONUS-VAULT/05-decision-templates.md](../../04-EPREUVE/01-BONUS-VAULT/05-decision-templates.md).
