...
// Exemple fictif : le panel « journalistes-MG » compte 1.5x dans ce produit.
// Si cette règle métier change : centraliser et tester tous les `VOTE_WEIGHT`.
// Ne présente pas une politique interne comme une règle FIFA ou un fait externe sans source.
