...
zone n'ait pas encore ete regardee en détail, pas qu'elle soit réglée.
...
- La négociation du budget ou du contrat avec le client n'est pas couverte ici : voir
  [09-TEAM-QUEST/04-communication-under-pressure.md](../09-TEAM-QUEST/04-communication-under-pressure.md).
- Le découpage du travail en tranches de valeur (base de ce niveau) est détaillé dans
  [05-MVP-SPLIT/02-slicing-value.md](../../01-CADRAGE/05-MVP-SPLIT/02-slicing-value.md), pas réexpliqué ici.
- La gestion d'un incident de production en cours de projet est couverte par
  [03-QUALITY-SHIELD/05-incidents-and-postmortem.md](../03-QUALITY-SHIELD/05-incidents-and-postmortem.md).

## 7. Prérequis

- Avoir déjà découpé un besoin en tranches verticales de valeur (05-MVP-SPLIT).
- Savoir estimer une tâche avec une fourchette plutôt qu'un chiffre unique
  ([05-MVP-SPLIT/04-estimating-honestly.md](../../01-CADRAGE/05-MVP-SPLIT/04-estimating-honestly.md)).
...
- [09-QUALITY-SHIELD](../03-QUALITY-SHIELD/README.md) réutilise la notion de jalon vérifiable
  pour définir ce qu'est un test qui "prouve" quelque chose plutôt qu'un test décoratif.
- [12-CAPSTONE-ARENA](../../04-EPREUVE/05-CAPSTONE-ARENA/README.md) exige un plan par phases avec risque
  nommé pour son propre projet final.
- [13-DAY-TO-LEGEND](../../05-MAITRISE/05-DAY-TO-LEGEND/README.md) réutilise le suivi par démonstration
