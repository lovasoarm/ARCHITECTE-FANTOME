...
> Ces questions portent sur `02-CONSTRUCTION/19_api_craft`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `02-CONSTRUCTION/19_api_craft/`, ou à sa synthèse `08_api_grimoire.md`.
