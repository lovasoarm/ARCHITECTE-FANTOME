...
Analogie : un flux Git, c'est la circulation en cuisine pendant le coup de feu, et le plan de manœuvre d'un équipage.
Où l'analogie casse : en cuisine on se croise en se parlant, sur Git on se croise sans se voir : le conflit se découvre à la fusion.
