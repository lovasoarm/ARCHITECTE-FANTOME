...
On te fournit un extrait qui gère un composant accessible (roles ARIA, focus trap) OU un pluriel i18n : issu de `03-PILOTAGE/02_web_inclusive/` ou `i18n/`. 15-25 minutes de lecture, pas plus.
