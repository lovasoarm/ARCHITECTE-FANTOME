...
# Boss 4 de 03-PILOTAGE : cloud foundations x produit cout roi

Ce Boss ferme les deux modules [cloud foundations](../07_cloud_foundations/README.md) et [produit cout roi](../08_produit_cout_roi/README.md). Il n'enseigne rien : il verifie que les deux tiennent
