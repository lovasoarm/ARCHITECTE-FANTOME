...
[Boss 9 de 02-CONSTRUCTION](README.md)

# Projet reel : oop js x web concepts

## Ce que tu livres

- Aucun boss-fight n'existait pour ces deux modules. La commande : livre, sur ton projet fil rouge, un increment qui ne tient que si [oop js](../17_oop_js/README.md) et [web concepts](../18_web_concepts/README.md) tiennent ensemble. Un increment qui passe en n'utilisant qu'un seul des deux modules ne compte pas.
