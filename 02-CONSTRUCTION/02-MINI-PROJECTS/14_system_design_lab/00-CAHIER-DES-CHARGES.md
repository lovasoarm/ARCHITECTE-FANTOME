...
`ARCHITECTURE.md`, ADRs, code fonctionnel, chaos test, `08-POSTMORTEM.md`, dépôt GitHub public.
...
## SPEC DRIFT DYNAMIQUE (obligatoire)
...
scénarios listés dans `05-SPEC-DRIFT-TRIGGERS.md` et joue-le honnêtement.
...
3. Une entrée dans `08-POSTMORTEM.md` : ce qui aurait rendu ta V1 plus tolérante
   à ce drift.
