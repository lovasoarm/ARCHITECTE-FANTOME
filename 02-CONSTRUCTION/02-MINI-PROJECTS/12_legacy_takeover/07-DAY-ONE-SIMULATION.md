...
# 09-DAY-ONE-SIMULATION.md : 4h chrono, ton premier jour dans une equipe
...
1. **1 MAP_15MIN.md** : produit avec le template
   `02-CONSTRUCTION/02-MINI-PROJECTS/97-templates/08-MAP_15MIN_TEMPLATE.md`. Rempli, pas ebauche.
2. **1 HYPOTHESES.md** : template
   `02-CONSTRUCTION/02-MINI-PROJECTS/97-templates/07-HYPOTHESES_TEMPLATE.md`. Trois hypotheses
