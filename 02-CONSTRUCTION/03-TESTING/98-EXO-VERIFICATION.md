...
# EXO [IA séduisante] : 02-construction/03-testing
...
Ecrire un test qui echoue avant le code, formuler l'assertion la plus specifique possible, c'est un muscle. l'IA t'ecrit vite un test qui passe toujours : ce IA séduisante prouve que tu sais ecrire un test qui refuse le mauvais code.
