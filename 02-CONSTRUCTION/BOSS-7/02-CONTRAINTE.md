...
- Aucun copier-coller depuis les modules [runtime env](../13_runtime_env/README.md) et [architecture patterns](../14_architecture_patterns/README.md) : tu ecris de tete, tu verifies apres.
