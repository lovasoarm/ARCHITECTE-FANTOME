...
# Boss 7 de 02-CONSTRUCTION : runtime env x architecture patterns

Ce Boss ferme les deux modules [runtime env](../13_runtime_env/README.md) et [architecture patterns](../14_architecture_patterns/README.md). Il n'enseigne rien : il verifie que les deux tiennent
