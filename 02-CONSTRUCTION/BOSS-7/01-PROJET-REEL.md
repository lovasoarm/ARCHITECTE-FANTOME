...
[Boss 7 de 02-CONSTRUCTION](README.md)

# Projet reel : runtime env x architecture patterns

## Ce que tu livres

- Aucun boss-fight n'existait pour ces deux modules. La commande : livre, sur ton projet fil rouge, un increment qui ne tient que si [runtime env](../13_runtime_env/README.md) et [architecture patterns](../14_architecture_patterns/README.md) tiennent ensemble. Un increment qui passe en n'utilisant qu'un seul des deux modules ne compte pas.
