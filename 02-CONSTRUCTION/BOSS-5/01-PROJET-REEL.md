...
[Boss 5 de 02-CONSTRUCTION](README.md)

# Projet reel : functional js x design patterns

## Ce que tu livres

- Aucun boss-fight n'existait pour ces deux modules. La commande : livre, sur ton projet fil rouge, un increment qui ne tient que si [functional js](../09_functional_js/README.md) et [design patterns](../10_design_patterns/README.md) tiennent ensemble. Un increment qui passe en n'utilisant qu'un seul des deux modules ne compte pas.
