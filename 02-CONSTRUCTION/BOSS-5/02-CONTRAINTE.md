...
- Aucun copier-coller depuis les modules [functional js](../09_functional_js/README.md) et [design patterns](../10_design_patterns/README.md) : tu ecris de tete, tu verifies apres.
