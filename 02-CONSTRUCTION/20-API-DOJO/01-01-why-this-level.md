...
[08-DATA-SPELLS](../08-DATA-SPELLS/README.md)) ni la façon dont la logique métier est organisée en
interne avant d'atteindre la route HTTP (traitée au [15-ARCHI-LAB](../15-ARCHI-LAB/README.md)). Il se
...
[module `03-PILOTAGE/01-ROADMAP-RUN`](../../03-PILOTAGE/01-ROADMAP-RUN/README.md), et les erreurs et limites définies ici alimentent
directement l'observabilité traitée au [module `03-PILOTAGE/03-QUALITY-SHIELD`](../../03-PILOTAGE/03-QUALITY-SHIELD/README.md).
