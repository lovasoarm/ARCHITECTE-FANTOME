...
> **CE MODULE RÉUTILISE** : structures de données (02-CONSTRUCTION/06-DATA-STRUCTURES), récursion (00-SOCLE/04-FUNDAMENTALS), async (01-CADRAGE/02-ASYNC). Si un de ces prérequis est flou, retourne le voir avant. Ce module ne les réexplique pas.
...
- toutes les structures de `02-CONSTRUCTION/06-DATA-STRUCTURES` : complet
- analyse de complexité ligne par ligne : voir `02-CONSTRUCTION/05-MEMORY-PERFORMANCE/03_complexity/03-complexity_analysis.md`
...
Oui, explicitement : "07 + 08, Data Structures + Algos : sans ça, t'es limité". Ce module dépend entièrement de `02-CONSTRUCTION/06-DATA-STRUCTURES` : tu ne peux pas comprendre Dijkstra sans comprendre les graphes et les heaps (`02-CONSTRUCTION/06-DATA-STRUCTURES/05_heap` et `02-CONSTRUCTION/06-DATA-STRUCTURES/08_graphs`), tu ne peux pas comprendre un tri efficace sans comprendre la notion de complexité vue en `02-CONSTRUCTION/05-MEMORY-PERFORMANCE/03_complexity`. Si tu n'as pas ces modules derrière toi : finis-les d'abord.
...
Maintenant, ouvre `02-bubble_insertion.md`. Et vois enfin pourquoi un algorithme lent existe encore, avant de comprendre pourquoi on ne l'utilise presque plus.
