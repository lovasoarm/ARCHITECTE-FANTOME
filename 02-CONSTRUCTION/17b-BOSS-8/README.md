...
# 17b-BOSS-8 : LE LANGAGE, LES FRONTIERES, LES OBJETS
...
- [ ] Contrat v2 avec double service et date d'extinction (voir module `02-CONSTRUCTION/14-ARCHITECTURE-PATTERNS`).
