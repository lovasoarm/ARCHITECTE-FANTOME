...
Quand « client » veut dire _prospect_ au marketing, _payeur_ à la facturation et _ligne en base_ pour
...
function getClient(
  id,
  { includeProspects = false, billingOnly = false, legacyShape = true } = {},
) {
