...
# drill_1 : restituer sans support : porte rasengan engine multilang
...
1. Le concept central du module, defini sans exemple.
2. Le mecanisme, explique de bout en bout.
3. Le cas ou il ne faut pas l'utiliser.
4. Le cout reel de la solution.
5. Le signal chiffre qui declenche sa remise en cause.
