...
Le projet couvre `02-CONSTRUCTION/12_typescript`, `03-PILOTAGE/05_observability`, `05-MAITRISE/02_scalability`. Le système de types est la contrainte centrale : si un event mal formé traverse le pipeline sans être intercepté, les ultras voient des données corrompues en direct pendant un match : pas acceptable.
