...
> **CE MODULE RÉUTILISE** : fonctions (00-SOCLE/04-FUNDAMENTALS), closures (00-SOCLE/04-FUNDAMENTALS). Si un de ces prérequis est flou, retourne le voir avant. Ce module ne les réexplique pas.
