...
> Ces questions portent sur `02-CONSTRUCTION/09_functional_js`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `02-CONSTRUCTION/09_functional_js/`, ou à sa synthèse `08_fp_grimoire.md`.
...
- `02-CONSTRUCTION/17_oop_js/01_prototype_chain_raw.md` (chaîne de prototypes brute)
- `02-CONSTRUCTION/17_oop_js/03_class_syntax_sugar.md` (class = sucre au-dessus des prototypes)
- `02-CONSTRUCTION/17_oop_js/06_inheritance_extends_super.md` (héritage vs composition)
- `02-CONSTRUCTION/17_oop_js/09_composition_vs_inheritance.md` (le choix par défaut moderne)
...
Si tu n'as pas encore fait `02-CONSTRUCTION/17_oop_js/`, ferme ce module maintenant, va
