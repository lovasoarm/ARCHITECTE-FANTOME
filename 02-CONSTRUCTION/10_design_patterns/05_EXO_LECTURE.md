...
On te fournit un extrait 30-60 lignes qui implémente un pattern (Strategy, Observer, Builder) sans le nommer : issu de `02-CONSTRUCTION/10_design_patterns/` ou de `02-CONSTRUCTION/02_mini_projects/01_rasengan_engine/`. 15-25 minutes de lecture, pas plus.
