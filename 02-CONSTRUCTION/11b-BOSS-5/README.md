...
# 11b-BOSS-5 : REPRENDRE DU CODE QUI FAIT PEUR
...
Un fichier de 600 lignes, sans test, doit accueillir une fonctionnalite nouvelle.
...
- [ ] Filet de tests de caracterisation ecrit AVANT toute modification.
- [ ] Refactoring par petits pas, un commit par pas, tests verts a chaque pas.
- [ ] Un pattern introduit, un seul, justifie par le besoin et pas par le catalogue.
