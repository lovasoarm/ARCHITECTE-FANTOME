...
> Ces questions portent sur `02-CONSTRUCTION/06_data_structures`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `02-CONSTRUCTION/06_data_structures/`, ou à sa synthèse `_recall_10.md`.
