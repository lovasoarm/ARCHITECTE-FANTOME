...
# Boss 4 de 02-CONSTRUCTION : algorithms x DATA SPELLS

Ce Boss ferme les deux modules [algorithms](../07_algorithms/README.md) et [DATA SPELLS](../08-DATA-SPELLS/README.md). Il n'enseigne rien : il verifie que les deux tiennent
