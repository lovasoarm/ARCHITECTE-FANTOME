...
On te fournit un extrait qui manipule des flottants ou des grands entiers (bit ops, modulo, IEEE 754) : issu de `02-CONSTRUCTION/04_math_basics/` ou d'un utilitaire mathématique. 15-25 minutes de lecture, pas plus.
