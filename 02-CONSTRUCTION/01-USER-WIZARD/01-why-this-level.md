...
[niveau 07](../20-API-DOJO/03-errors-and-idempotence.md). Il ne couvre pas non plus la
modélisation des données sous-jacentes à ces écrans, traitée au
[niveau 05](../08-DATA-SPELLS/README.md).

## Prérequis réels

Avoir suivi le [niveau 03](../../01-CADRAGE/05-MVP-SPLIT/README.md) : un parcours utilisateur ne se conçoit
...
[niveau 07](../20-API-DOJO/03-errors-and-idempotence.md). La discipline de lister les états
avant de coder prépare directement l'observabilité traitée au
[niveau 09](../../03-PILOTAGE/03-QUALITY-SHIELD/03-observability.md).
