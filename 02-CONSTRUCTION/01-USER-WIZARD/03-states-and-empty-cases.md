...
Analogie : les états vides, c'est une salle avant le premier client, et un plateau de régie avant que la lumière monte.
Où l'analogie casse : la salle vide se voit d'un coup d'œil, un état vide non conçu s'affiche comme une panne.
