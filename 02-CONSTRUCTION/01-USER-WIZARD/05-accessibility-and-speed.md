...
Analogie : l'accessibilité, c'est l'éclairage de service d'une régie, et le balisage d'un sentier de montagne.
Où l'analogie casse : un balisage aide tout le monde de la même façon, une interface doit s'adapter à des perceptions différentes.
