...
Analogie : un formulaire honnête, c'est la fiche d'admission aux urgences, et le bon de commande passé au passe.
Où l'analogie casse : la fiche d'admission est remplie par un professionnel, ton formulaire par quelqu'un de pressé sur un quai de gare.
