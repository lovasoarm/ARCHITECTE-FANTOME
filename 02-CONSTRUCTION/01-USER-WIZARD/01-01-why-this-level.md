...
[20-API-DOJO](../20-API-DOJO/03-errors-and-idempotence.md). Il ne couvre pas non plus la
modélisation des données sous-jacentes à ces écrans, traitée au
[08-DATA-SPELLS](../08-DATA-SPELLS/README.md).

## Prérequis réels

Avoir suivi le [05-MVP-SPLIT](../../01-CADRAGE/05-MVP-SPLIT/README.md) : un parcours utilisateur ne se conçoit
...
## Pourquoi la véto et pas une list

Une list n'a pas de concurrence réelle (peu importe qui coche la case en premier), pas
...
[20-API-DOJO](../20-API-DOJO/03-errors-and-idempotence.md). La discipline de lister les états
avant de coder prépare directement l'observabilité traitée au
[module `03-PILOTAGE/03-QUALITY-SHIELD`](../../03-PILOTAGE/03-QUALITY-SHIELD/03-observability.md).
