...
> Ces questions portent sur `02-CONSTRUCTION/12_typescript`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `02-CONSTRUCTION/12_typescript/`, ou à sa synthèse `04_typescript_grimoire.md`.
