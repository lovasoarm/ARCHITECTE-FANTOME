...
const graph = {
  Albuquerque: [
    { node: "Santa Fe", weight: 45 },
    { node: "Roswell", weight: 120 },
  ],
...
```js
const deps = [
  ["01-CADRAGE/02-ASYNC", "00-SOCLE/04-FUNDAMENTALS"],
  ["03-TESTING", "00-SOCLE/04-FUNDAMENTALS"],
  ["03-TESTING", "01-CADRAGE/02-ASYNC"],
  ["07_structures", "00-SOCLE/04-FUNDAMENTALS"],
  ["02-CONSTRUCTION/07-ALGORITHMS", "07_structures"],
  ["10_patterns", "09_functional"],
  ["10_patterns", "02-CONSTRUCTION/11-REFACTORING"],
];
// [module, prérequis] : pour installer module, il faut d'abord prérequis
```

Construis un graphe dirigé. Implémente `canBuild(module)` : retourne `true` si le module est atteignable depuis "00-SOCLE/04-FUNDAMENTALS" (toutes ses dépendances sont disponibles).
