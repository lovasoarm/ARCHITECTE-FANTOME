...
Sinon ton RNG ment. Il génère des résultats qui _semblent_ aléatoires mais qui ne le sont pas.
...
class PityDrop {
  ...
  roll() {
    ...
    const progressRate =
      this.attempts > this.pityThreshold * 0.5
...
T'as un système d'A/B test pour ton projet fil rouge.
