...
Toujours zéro mutation : `executeAttack` retourne un NOUVEAU `defender`, jamais modifié sur place. Strategy + immutabilité = combo qui revient tout au long de `02-CONSTRUCTION/10-DESIGN-PATTERNS`.
