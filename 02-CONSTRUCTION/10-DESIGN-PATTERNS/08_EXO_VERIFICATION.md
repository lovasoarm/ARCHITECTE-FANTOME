...
# Vérification : 08_EXO_VERIFICATION.md
...
Tu demandes à une IA générique d'écrire des tests pour `LabManager` (voir `03-singleton_pattern.md`), le singleton qui gère le labo. Voici ce qu'elle génère :
