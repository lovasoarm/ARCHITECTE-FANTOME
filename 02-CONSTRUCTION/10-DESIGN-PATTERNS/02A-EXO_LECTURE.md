...
On te fournit un extrait 30-60 lignes qui implémente un pattern (Strategy, Observer, Builder) sans le nommer : issu de `02-CONSTRUCTION/10-DESIGN-PATTERNS/` ou de `02-CONSTRUCTION/02-MINI-PROJECTS/01_rasengan_engine/`. 15-25 minutes de lecture, pas plus.
