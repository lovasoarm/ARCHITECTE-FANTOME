...
[Boss 2 de 02-CONSTRUCTION](README.md)

# Projet reel : testing x math basics

## Ce que tu livres

- Aucun boss-fight n'existait pour ces deux modules. La commande : livre, sur ton projet fil rouge, un increment qui ne tient que si [testing](../03_testing/README.md) et [math basics](../04_math_basics/README.md) tiennent ensemble. Un increment qui passe en n'utilisant qu'un seul des deux modules ne compte pas.
