...
| Il mobilise reellement les deux modules [testing](../03_testing/README.md) et [math basics](../04_math_basics/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `02-CONSTRUCTION/BOSS-2 : PASSE le <date>`. Sans cette ligne, les deux
