...
Prends `02-CONSTRUCTION/02_mini_projects/10_legacy_dungeon` (ou n'importe quel repo public). Chasse **7 smells** de la liste. Pour chacun : ligne, verdict (corrigé / laissé volontairement), justification en 2 lignes.
