...
On te fournit un extrait TS avec types conditionnels, `infer`, discriminated union ou template literal types : issu de `02-CONSTRUCTION/12_typescript/03_ts_advanced/`. 15-25 minutes de lecture, pas plus.
