...
Module : **02-CONSTRUCTION/12_typescript** : typage statique et generics.
...
- **Go** : Go : typage statique nominal ; generics depuis 1.18 (`func F(x T)` avec un paramètre de type `T any`) ; pas de types utilitaires, on ecrit chaque type.
