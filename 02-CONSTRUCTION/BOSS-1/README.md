...
# Boss 1 de 02-CONSTRUCTION : USER WIZARD x mini projects

Ce Boss ferme les deux modules [USER WIZARD](../01-USER-WIZARD/README.md) et [mini projects](../02_mini_projects/README.md). Il n'enseigne rien : il verifie que les deux tiennent
