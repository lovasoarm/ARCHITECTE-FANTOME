...
[Boss 8 de 02-CONSTRUCTION](README.md)
...
| Il mobilise reellement les deux modules [ARCHI LAB](../15-ARCHI-LAB/README.md) et [ddd contrats](../16_ddd_contrats/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `02-CONSTRUCTION/BOSS-8 : PASSE le <date>`. Sans cette ligne, les deux
