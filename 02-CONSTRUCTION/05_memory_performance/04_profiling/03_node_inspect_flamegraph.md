...
Prends `02-CONSTRUCTION/02_mini_projects/11_scheduler` (ou n'importe quel script Node). Génère un flame. Identifie la fonction la plus chaude. Optimise-la. Remesure.
