...
> **CE MODULE RÉUTILISE** : closures (00-SOCLE/04-FUNDAMENTALS), async (01-CADRAGE/02-ASYNC), bits & représentation (02-CONSTRUCTION/04-MATH-BASICS). Si un de ces prérequis est flou, retourne le voir avant. Ce module ne les réexplique pas.

> **AVANT D'OUVRIR CE MODULE** : si tu n'as pas lu `../04-MATH-BASICS/10-PONT-MEMORY-PERFORMANCE.md` (le pont bits-mémoire), fais-le d'abord. Sans cette image mentale, ce qui suit reste des mots.
...
Maintenant, ouvre `02-gc_basics.md`. Et découvre ce que ton code laisse vraiment traîner en mémoire.
