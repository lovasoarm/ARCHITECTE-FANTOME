...
Prérequis : `02-profiling_basics.md`, `05-devtools_deep_dive.md`.
...
La solution : `worker_threads` pour sortir le calcul lourd du main thread (voir `02-CONSTRUCTION/13-RUNTIME-ENV/06A-worker_threads.md`).
