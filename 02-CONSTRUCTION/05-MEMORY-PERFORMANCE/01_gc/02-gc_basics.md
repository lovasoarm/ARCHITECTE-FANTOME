...
- **Modèle pédagogique** : on représente souvent la pile d’exécution et une zone de tas distincte pour visualiser les références et le GC.
- **Attention** : JavaScript ne garantit pas que les primitives, objets, fonctions ou références correspondent littéralement à des zones mémoire fixes.

La durée de vie des cadres d’exécution et la récupération des objets dépendent du moteur et de ses règles d’exécution et de GC.
