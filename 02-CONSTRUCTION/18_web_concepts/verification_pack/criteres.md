...
# criteres : verification_pack de web concepts
...
([README](../../../06-ANNEXES-TRANSVERSES/03-TECH-ILA/README.md)). Ce module porte son jalon 2 sur 6. Le jalon precede les trois drills
et ne se compense pas.

| Verification | Portee | Verdict |
| --- | --- | --- |
| Jalon 2 TECH-ILA franchi | [Niveau 2 : Frontend](../../../06-ANNEXES-TRANSVERSES/03-TECH-ILA/tech-ila/02-niveau-2-frontend.md) | Jalon non franchi = **module non valide**, meme avec trois drills REUSSI |

Niveau attendu, binaire : une page servie par toi, avec la strategie de rendu nommee, un chiffre de performance mesure et un defaut d'accessibilite corrige.

Trace exigee : une ligne datee dans ton depot, `TECH-ILA jalon 2 franchi le <date> : <chemin de l'artefact>`.
