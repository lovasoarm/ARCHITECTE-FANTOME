...
> Ces questions portent sur `02-CONSTRUCTION/14_architecture_patterns`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `02-CONSTRUCTION/14_architecture_patterns/`, ou à sa synthèse `07_architecture_grimoire.md`.
