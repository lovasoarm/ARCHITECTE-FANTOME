...
[Boss 6 de 02-CONSTRUCTION](README.md)
...
| Il mobilise reellement les deux modules [refactoring](../11_refactoring/README.md) et [typescript](../12_typescript/README.md) | Un seul des deux = **ne passe pas** |
...
Une ligne dans `PROGRESSION.md` : `02-CONSTRUCTION/BOSS-6 : PASSE le <date>`. Sans cette ligne, les deux
