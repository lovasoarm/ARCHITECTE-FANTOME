...
# Boss 6 de 02-CONSTRUCTION : refactoring x typescript

Ce Boss ferme les deux modules [refactoring](../11_refactoring/README.md) et [typescript](../12_typescript/README.md). Il n'enseigne rien : il verifie que les deux tiennent
