...
[08-DATA-SPELLS](../08-DATA-SPELLS/README.md)) ni la conception du contrat d'API exposé vers
l'extérieur (traitée au [20-API-DOJO](../20-API-DOJO/README.md)). Il se concentre sur l'organisation
...
peut évoluer sans casser ses appelants, traitée au [20-API-DOJO](../20-API-DOJO/README.md), et la
capacité à observer où un système ralentit, traitée au
[module `03-PILOTAGE/03-QUALITY-SHIELD`](../../03-PILOTAGE/03-QUALITY-SHIELD/README.md).
