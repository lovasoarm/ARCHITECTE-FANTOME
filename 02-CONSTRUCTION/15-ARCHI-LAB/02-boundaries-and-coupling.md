...
peut débrancher une console entre deux scènes. Un module trop couplé en production continue
de tourner pendant qu'on tente de le découper, avec des appelants qui dépendent déjà de ses
détails internes.
