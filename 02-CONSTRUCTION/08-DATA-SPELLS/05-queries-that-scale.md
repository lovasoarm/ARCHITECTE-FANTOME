...
| -------------------------------------- | ------------------------------------------------------------ | --------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| Requête groupée (batch) au lieu de N+1 | Requête un peu plus complexe à écrire                        | Réduit fortement le nombre d'allers-retours dans les cas adaptés            | Dès qu'une boucle crée un N+1 mesurable ou prévisible ; valider l'indexation et la forme de requête |
