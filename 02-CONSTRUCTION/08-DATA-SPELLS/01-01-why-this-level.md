...
[01-USER-WIZARD](../01-USER-WIZARD/README.md)) ni la façon d'exposer ces données via une API (traitée au
[20-API-DOJO](../20-API-DOJO/README.md)). Il se concentre sur la structure qui rend les deux fiables
...
Le schéma construit ici porte directement les contrats d'API du [20-API-DOJO](../20-API-DOJO/README.md)
et les décisions d'architecture du [15-ARCHI-LAB](../15-ARCHI-LAB/README.md) : une entité mal nommée ou
