...
> Ces questions portent sur `02-CONSTRUCTION/18_web_concepts`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `02-CONSTRUCTION/18_web_concepts/`, ou à sa synthèse `08_web_concepts_grimoire.md`.
