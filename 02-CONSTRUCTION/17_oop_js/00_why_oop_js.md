...
> **CE MODULE RÉUTILISE** : fonctions (00-SOCLE/04_fundamentals), closures (00-SOCLE/04_fundamentals). Si un de ces prérequis est flou, retourne le voir avant. Ce module ne les réexplique pas.
