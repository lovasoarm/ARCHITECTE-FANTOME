...
> Ces questions portent sur `02-CONSTRUCTION/13_runtime_env`, le module que tu viens de finir.
...
- **2 ou moins** → retour à `02-CONSTRUCTION/13_runtime_env/`, ou à sa synthèse `07_runtime_grimoire.md`.
