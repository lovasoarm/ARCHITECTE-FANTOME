...
de référence (`30_mini_projects/README.md`) donne une règle claire :
...
██████████████████████████████████████████████████████████████████████
   ...
   05-DATA-SPELLS                              qu'il doit faire)
     (organiser les données de ton           07_math_basics
   ...
   06-ARCHI-LAB                                 dont ton code a besoin,
     (décider comment organiser ton             genre les arrondis)
      code pour qu'il tienne debout)          08_memory_performance
   07-API-DOJO                                  (comment ton programme
     (écrire les règles par lesquelles           gère sa mémoire)
      deux programmes se parlent)             09_data_structures
...
██████████████████████████████████████████████████████████████████████
   ...
   Côté ProjectFunny (le fil conducteur)   Côté MyFunnyJS (en soutien)
   ──────────────────────────────────      ────────────────────────────
   08-ROADMAP-RUN                          19_web_inclusive
...
██████████████████████████████████████████████████████████████████████
   ...
   Côté ProjectFunny (le fil conducteur)   Côté MyFunnyJS (en soutien)
   ──────────────────────────────────      ────────────────────────────
   15-BONUS-VAULT (section 05)             20_realtime
   ...
   14-TOOL-CAVE (sections 03 et 05)         23_ai_native_dev
   ...
   fichier de règles pour les mini-projets (`30_mini_projects/README.md`)
...
██████████████████████████████████████████████████████████████████████
   ...
   15-BONUS-VAULT (le reste)               25_scalability
                                            ...
                                            30_mini_projects (les
                                              projets 15 à 17,
                                              après les modules 23-29)
                                            31_annexes (préparer un
...
SEMAINES 1 à 9      [SOCLE]
                    MyFunnyJS : 00_getting_started -> 00_referentiel -> 01 -> 02
                    ProjectFunny : 00 -> 01
...
│  Un bug bizarre que tu comprends │  MyFunnyJS 04_debugging +           │
│  pas                             │  ProjectFunny 14-TOOL-CAVE          │
│  Comprendre les fonctions et la  │  MyFunnyJS 01_fundamentals          │
│  mémoire de tes variables        │                                     │
│  Comprendre comment JS gère      │  MyFunnyJS 03_async                 │
│  l'attente (une requête réseau,  │                                     │
│  par exemple)                    │                                     │
│  Écrire tes premiers tests       │  MyFunnyJS 06_testing + ProjectFunny│
│                                   │  09                                 │
│  Nettoyer du code qui marche     │  MyFunnyJS 13_refactoring           │
│  mais qui pue                    │                                     │
│  Sécuriser ton appli (mots de    │  MyFunnyJS 22_security +            │
...
(`00_referentiel/06_intemporel_vs_perissable.md`) et ProjectFunny pareil
...
(Le module `00_getting_started`, lui aussi classé "2 ans" dans le fichier
