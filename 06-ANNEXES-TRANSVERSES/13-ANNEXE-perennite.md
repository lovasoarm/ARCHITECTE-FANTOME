...
14 TOOL-CAVE
  ...
  périssable : 04-audit-dune-decision-technique.md dans son intégralité, à revoir à chaque saut de
...
4. **Revue annuelle.** Une fois par an, relis les études de cas du module `04-EPREUVE/04-BIG-APP-SNOOP` : ce sont elles qui
...
- La leçon sur l'IA comme outil (`../04-EPREUVE/02-TOOL-CAVE/04-audit-dune-decision-technique.md`) : c'est la plus volatile.
...
au format déjà en usage dans `../02-CONSTRUCTION/08-DATA-SPELLS/90-grimoire.md` et `../03-PILOTAGE/03-QUALITY-SHIELD/90-grimoire.md`.
