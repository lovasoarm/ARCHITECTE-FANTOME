...
Un livrable chiffré sans colonne URL et sans date est refusé, quelle que soit la qualité du raisonnement. Le [challenge du module cloud](../03-PILOTAGE/07-CLOUD-FOUNDATIONS/95-challenge.md) impose un relevé personnel de trois prix unitaires chez deux fournisseurs, et une réponse écrite à l'objection "vos prix datent de quand ?".

## 4. Le verrou

Le contrôle de livraison automatique du dépôt refuse tout tableau contenant un montant en euros qui ne porte pas sa ligne de relevé datée et sourcée. Ce n'est pas une consigne d'écriture : c'est un refus mécanique.

## 5. Où le protocole s'applique en premier

- [03-PILOTAGE/07-CLOUD-FOUNDATIONS/04-choisir_fournisseur.md](../03-PILOTAGE/07-CLOUD-FOUNDATIONS/04-choisir_fournisseur.md) : la grille comparative.
- [03-PILOTAGE/07-CLOUD-FOUNDATIONS/06A-BUDGET-CLOUD.md](../03-PILOTAGE/07-CLOUD-FOUNDATIONS/06A-BUDGET-CLOUD.md) : le gabarit du livrable S1.
- [02-S1-BUDGET-CLOUD.md](17-PREUVES-MODELES/02-S1-BUDGET-CLOUD.md) : l'exemplaire de référence.
- [03-PILOTAGE/07-CLOUD-FOUNDATIONS/99-PORTAGE-MENTAL.md](../03-PILOTAGE/07-CLOUD-FOUNDATIONS/99-PORTAGE-MENTAL.md) : le portage chez un second fournisseur.
