...
# UNIVERS AUTORISÉS DANS ARCHITECTE-FANTOME

Temps de lecture ~3 min

> **Source unique.** Ce fichier EST la liste que lit le lint
> (`99-COULISSES/outillage/verifier_univers.mjs`) : aucune autre page ne
> redonne la liste, elles pointent toutes ici.
>
