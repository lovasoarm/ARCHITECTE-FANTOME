...
Avant les 34 fiches en détail, la carte complète. Le socle compte pour deux fiches (Getting Started et Référentiel) : au total, 34 fiches réparties sur les 54 modules pédagogiques directs des six paliers. Tu la relis en 2 minutes quand tu veux savoir où mettre ton énergie de révision cette semaine.

| Coordonnée                                 | Module          | Ce que tu dois en garder                         | Statut 10 ans                   |
| ------------------------------------------ | --------------- | ------------------------------------------------ | ------------------------------- |
| `00-SOCLE/01-GETTING-STARTED`              | Getting Started | Node LTS, `.nvmrc`, hygiène du jour 1            | Stable                          |
| `00-SOCLE/03-REFERENTIEL`                  | Référentiel     | Révision espacée à J+1/J+7/J+21/J+60             | Intemporel                      |
| `00-SOCLE/04-FUNDAMENTALS`                 | Fundamentals    | Closures, types, `===`                           | Intemporel                      |
| `00-SOCLE/05-PROBLEM-SOLVING`              | Problem Solving | Méthode Polya                                    | Intemporel                      |
| `01-CADRAGE/02-ASYNC`                      | Async           | Boucle d'événements, micro/macrotasks            | Intemporel                      |
| `01-CADRAGE/03-DEBUGGING`                  | Debugging       | Hypothèse avant test                             | Intemporel                      |
| `01-CADRAGE/04-ERROR-HANDLING`             | Error Handling  | Erreurs typées, pas de try/catch générique       | Stable                          |
| `02-CONSTRUCTION/03-TESTING`               | Testing         | Comportement, pas implémentation                 | Intemporel (syntaxe périssable) |
| `02-CONSTRUCTION/04-MATH-BASICS`           | Math            | Falsy, modulo JS, hash ≠ chiffrement             | Intemporel                      |
| `02-CONSTRUCTION/05-MEMORY-PERFORMANCE`    | Memory & Perf   | Mesurer avant d'optimiser, closures qui fuient   | Intemporel                      |
| `02-CONSTRUCTION/06-DATA-STRUCTURES`       | Data Structures | Map/Set en réflexe                               | Intemporel                      |
| `02-CONSTRUCTION/07-ALGORITHMS`            | Algorithms      | Reconnaître le pattern                           | Intemporel                      |
| `02-CONSTRUCTION/09-FUNCTIONAL-JS`         | Functional JS   | Pureté, immutabilité                             | Intemporel                      |
| `02-CONSTRUCTION/10-DESIGN-PATTERNS`       | Design Patterns | Vocabulaire commun                               | Stable                          |
| `02-CONSTRUCTION/11-REFACTORING`           | Refactoring     | Renommer avant de découper                       | Intemporel                      |
| `02-CONSTRUCTION/12-TYPESCRIPT`            | TypeScript      | Types qui distinguent les cas, `unknown`         | **Périssable : 2027**           |
| `02-CONSTRUCTION/13-RUNTIME-ENV`           | Runtime Env     | Node vs Browser                                  | Stable                          |
| `02-CONSTRUCTION/14-ARCHITECTURE-PATTERNS` | Architecture    | Dépendances vers le domaine (le cœur métier)     | Intemporel                      |
| `02-CONSTRUCTION/18-WEB-CONCEPTS`          | Web Concepts    | Pipeline d'affichage, connexion ≠ droits         | Stable                          |
| `02-CONSTRUCTION/17-OOP-JS`                | OOP JS          | `this`, prototype                                | Intemporel                      |
| `03-PILOTAGE/02-WEB-INCLUSIVE`             | Web Inclusive   | Accessibilité = contrainte, pas couche           | Intemporel                      |
| `04-EPREUVE/03-REALTIME`                   | Realtime        | WebSocket / SSE / WebRTC, le bon choix           | Stable                          |
| `02-CONSTRUCTION/19-API-CRAFT`             | API Craft       | Rejouable sans risque, limite de débit, versions | Stable                          |
| `03-PILOTAGE/04-SECURITY`                  | Security        | Donnée user = hostile par défaut                 | Intemporel                      |
| `04-EPREUVE/04-BIG-APP-SNOOP`              | IA-Native Dev   | 4 niveaux de validation                          | **Périssable : 2028**           |
| `05-MAITRISE/01-DATABASES`                 | Databases       | Requêtes de base, transactions tout-ou-rien      | Intemporel                      |
| `05-MAITRISE/02-SCALABILITY`               | Scalability     | 8 croyances fausses sur le distribué             | Intemporel                      |
| `03-PILOTAGE/05-OBSERVABILITY`             | Observability   | Logs + traces + indicateurs de santé             | Stable                          |
| `03-PILOTAGE/10-TEAM-CRAFT`                | Team Craft      | Expliquer à 3 publics                            | Intemporel                      |
| `05-MAITRISE/03-EDGE-CASES`                | Edge Cases      | Accès concurrents = coordination                 | Intemporel                      |
| `05-MAITRISE/03-EDGE-CASES`                | IA Agents       | B.O.R.N.É., isolation obligatoire                | **Périssable : 2028**           |
| `02-CONSTRUCTION/02-MINI-PROJECTS`         | Mini-Projets    | Ce qu'ils prouvent, pas leur code                | Intemporel (la méthode)         |
| `05-MAITRISE/06-ANNEXES`                   | Annexes         | Ne pas coder, quand c'est mieux ainsi            | Intemporel                      |
| `05-MAITRISE/07-TOOLS`                     | Tools           | 3 scripts perso, pas 30                          | Très périssable                 |

**Lecture rapide** : 22 fiches intemporelles (le socle qui ne bouge pas), 8 stables (bougent lentement), 3 explicitement datées (TypeScript, IA-Native Dev, IA Agents : à revalider à leur échéance), 1 très périssable (Tools, les outils changent tout le temps). Total : 34. Si tu dois choisir où réviser en premier avant un entretien : les intemporelles d'abord, elles ne périment jamais.
...
_Fichier : `05-MAITRISE/06-ANNEXES/99A-PONT.md`_

---

## 00-SOCLE/01-GETTING-STARTED · Getting Started
...
_Fichier : `../00-SOCLE/01-GETTING-STARTED/02-install.md`_
...
## 00-SOCLE/03-REFERENTIEL · Référentiel

_la boussole avant les modules_

**Noyau ** : révision espacée : tu revois chaque module à J+1, J+7, J+21, J+60 après l'avoir appris. Sans espacement et récupération active, la rétention peut fortement diminuer ; le rythme J+1/J+7/J+21/J+60 est ici une heuristique de travail, pas une loi universelle.
_Fichier : `../00-SOCLE/03-REFERENTIEL/01-00-why-referentiel.md`_
...
## 00-SOCLE/04-FUNDAMENTALS · Fundamentals
...
_Fichier : `00-SOCLE/04-FUNDAMENTALS/02_scope/04-closure_trap.md`_
...
## 00-SOCLE/05-PROBLEM-SOLVING · Problem Solving
...
_Fichier : `../00-SOCLE/05-PROBLEM-SOLVING/02-polya_method.md`_
...
_Fichier : `01-CADRAGE/02-ASYNC/04_event_loop/90-grimoire.md`_

```json
[ CALL STACK ] <-- traitée avant la file de microtasks dans le modèle pédagogique présenté ici
    |
    v (stack vide ?)
...
**Pont** : le temps réel (module `04-EPREUVE/03-REALTIME`), l'observabilité (module `03-PILOTAGE/05-OBSERVABILITY`), et les accès concurrents (module `05-MAITRISE/03-EDGE-CASES`) partent tous de ce module.

---

## 01-CADRAGE/03-DEBUGGING · Debugging
...
_Fichier : `../01-CADRAGE/03-DEBUGGING/06-hypothesis_driven_debug.md`_
...
## 01-CADRAGE/04-ERROR-HANDLING · Error Handling
...
_Fichier : `01-CADRAGE/04-ERROR-HANDLING/03-custom_errors.md`_
...
## 02-CONSTRUCTION/03-TESTING · Testing
...
_Fichier : `02-CONSTRUCTION/03-TESTING/02-unit_sniper.md`_
...
## 02-CONSTRUCTION/04-MATH-BASICS · Math
...
_Fichier : `../02-CONSTRUCTION/04-MATH-BASICS/02-boolean_logic.md`_
...
## 02-CONSTRUCTION/05-MEMORY-PERFORMANCE · Memory & Performance
...
_Fichier : `02-CONSTRUCTION/05-MEMORY-PERFORMANCE/04_profiling/02-profiling_basics.md`_

**Noyau** : une fonction reçoit toujours des valeurs ; pour un objet, cette valeur peut désigner le même objet que celui détenu par l'appelant. Les primitives sont des valeurs immuables du point de vue du langage. Une closure qui garde une valeur désignant un gros objet peut empêcher sa récupération tant que cette closure reste accessible : c'est une cause fréquente de rétention mémoire, à confirmer par mesure.
...
## 02-CONSTRUCTION/06-DATA-STRUCTURES · Data Structures

_les 8 qui couvrent une grande partie des besoins courants_
...
_Fichier : `02-CONSTRUCTION/06-DATA-STRUCTURES/07_hash_table/02-hash_table_basics.md`_
...
## 02-CONSTRUCTION/07-ALGORITHMS · Algorithms
...
_Fichier : `../02-CONSTRUCTION/07-ALGORITHMS/02_searching/02-linear_binary.md`_
...
## 02-CONSTRUCTION/09-FUNCTIONAL-JS · Functional JS
...
_Fichier : `../02-CONSTRUCTION/09-FUNCTIONAL-JS/02-pure_functions.md`_
...
## 02-CONSTRUCTION/10-DESIGN-PATTERNS · Design Patterns
...
_Fichier : `../02-CONSTRUCTION/10-DESIGN-PATTERNS/90-grimoire.md`_
...
## 02-CONSTRUCTION/11-REFACTORING · Refactoring
...
_Fichier : `../02-CONSTRUCTION/11-REFACTORING/03-clean_code_basics.md`_
...
## 02-CONSTRUCTION/13-RUNTIME-ENV · Runtime Env
...
_Fichier : `02-CONSTRUCTION/13-RUNTIME-ENV/02-node_vs_browser.md`_
...
## 02-CONSTRUCTION/14-ARCHITECTURE-PATTERNS · Architecture
...
_Fichier : `02-CONSTRUCTION/14-ARCHITECTURE-PATTERNS/05-clean_architecture.md`_
...
## 02-CONSTRUCTION/18-WEB-CONCEPTS · Web Concepts

_ce que tout dev web sait à froid_

**Noyau ** : le pipeline d'affichage d'une page : parse (lire le HTML) → DOM (construire l'arbre de la page) → CSSOM (construire l'arbre des styles) → layout (calculer les positions) → paint (dessiner les pixels) → composite (assembler les calques déjà dessinés). Un "reflow" (recalculer toute la mise en page) coûte cher en performance, un "composite" (juste réafficher des calques déjà prêts) ne coûte presque rien. C'est un modèle utile pour guider une partie importante du raisonnement de performance front.
_Fichier : `02-CONSTRUCTION/18-WEB-CONCEPTS/03-browser_render_pipeline.md`_
...
## 02-CONSTRUCTION/17-OOP-JS · OOP JS
...
_Fichier : `../02-CONSTRUCTION/17-OOP-JS/05-this_keyword_rules.md`_

**Piège** : oublier que `class` n'est qu'une écriture plus lisible par-dessus les prototypes (le mécanisme d'héritage natif de JS). `Object.getPrototypeOf` remonte la chaîne de prototypes et couvre une grande partie des diagnostics de recherche de méthode dans la chaîne de prototypes.

**Zappable** : préfère la composition (assembler des objets) à l'héritage (hérite uniquement quand la relation "est un" tient vraiment dans les cas où la relation "est un" reste réellement pertinente). `call`/`apply`/`bind` : `bind` fige définitivement le contexte `this`, `call`/`apply` l'invoquent directement : utile pour les callbacks qui perdent leur contexte d'origine.

---

## 03-PILOTAGE/02-WEB-INCLUSIVE · Web Inclusive

_accessibilité (a11y) et internationalisation (i18n), pas des couches ajoutées après_

**Noyau ** : l'accessibilité est une contrainte de conception dès le départ, pas une couche qu'on ajoute à la fin. Un composant inaccessible est un composant cassé, pour une part importante des utilisateurs, dont la proportion dépend des populations et définitions retenues.
_Fichier : `../03-PILOTAGE/02-WEB-INCLUSIVE/01-03-01-a11y-why-it-matters.md`_
...
**Zappable** : le focus visible (voir où on en est au clavier), une tabulation logique, et la touche Escape qui ferme les fenêtres modales : cela couvre plusieurs contrôles fréquents des audits d'accessibilité, mais ne remplace pas un audit complet. Le niveau WCAG AA (la norme d'accessibilité web) demande un rapport de contraste d'au moins 4.5:1 pour du texte normal, 3:1 pour du grand texte.
...
## 04-EPREUVE/03-REALTIME · Realtime
...
_Fichier : `04-EPREUVE/03-REALTIME/90-grimoire.md`_
...
**Piège** : partir sur des WebSockets par défaut est l'erreur la plus fréquente. Le SSE peut suffire dans de nombreux cas de diffusion serveur→client lorsque le besoin reste unidirectionnel, et t'évite l'enfer de la reconnexion automatique.
...
## 02-CONSTRUCTION/19-API-CRAFT · API Craft

_REST et au-delà_

**Noyau ** : des ressources nommées au pluriel, des verbes HTTP porteurs de sens, des statuts de réponse corrects. L'idempotence (`GET`/`PUT`/`DELETE` peuvent être rejoués plusieurs fois sans changer le résultat, contrairement à `POST`) forme un socle important d'une API cohérente, à compléter par les contraintes métier et opérationnelles.
_Fichier : `02-CONSTRUCTION/19-API-CRAFT/90-grimoire.md`_
...
## 03-PILOTAGE/04-SECURITY · Security
...
_Fichier : `03-PILOTAGE/04-SECURITY/90-grimoire.md`_
...
## 04-EPREUVE/04-BIG-APP-SNOOP · IA-Native Dev
...
**Piège** : l'IA invente des API avec un aplomb total : elle génère ce qui ressemble à la bonne réponse, pas forcément ce qui l'est vraiment. Vérifie toujours la doc avant d'accepter un import que tu ne connais pas. Jamais de secret dans un consigne, jamais de code d'un client sans autorisation explicite.

**Zappable** : un consigne utile est spécifique, contextualisé, et donne un critère de succès clair.

**Pont** : ce module éclaire le testing (ne fais jamais confiance aveuglément aux tests générés par l'IA), les agents autonomes (module `05-MAITRISE/03-EDGE-CASES`, même échéance de péremption : 2028), et toute la surface sécurité.

---

## 05-MAITRISE/01-DATABASES · Databases

_SQL d'abord, NoSQL quand c'est justifié_

**Noyau ** : `SELECT` (choisir des colonnes), `JOIN` (relier deux tables entre elles), `GROUP BY` (regrouper des lignes pour calculer des totaux), et les index (des raccourcis de recherche) couvrent une grande partie des besoins courants. Un dev qui ne sait pas lire un `EXPLAIN` (la commande qui montre comment la base va exécuter ta requête) se prive d'un outil majeur pour comprendre et diagnostiquer la performance d'une base de données.
_Fichier : `05-MAITRISE/01-DATABASES/90-grimoire.md`_
...
_Fichier : `05-MAITRISE/01-DATABASES/04-data_modeling.md`_
...
**Pont** : les transactions recoupent la gestion d'erreur (module `01-CADRAGE/04-ERROR-HANDLING`) : qui annule quoi, à quel niveau, si une opération composée de plusieurs étapes échoue à mi-chemin.

---

## 05-MAITRISE/02-SCALABILITY · Scalability
...
_Fichier : `05-MAITRISE/02-SCALABILITY/04-distributed_fallacies.md`_
...
## 03-PILOTAGE/05-OBSERVABILITY · Observability
...
_Fichier : `03-PILOTAGE/05-OBSERVABILITY/03-distributed_tracing.md`_
...
## 03-PILOTAGE/10-TEAM-CRAFT · Team Craft
...
_Fichier : `03-PILOTAGE/10-TEAM-CRAFT/13-three_audiences_intro.md`_
...
## 05-MAITRISE/03-EDGE-CASES · Edge Cases
...
_Fichier : `../05-MAITRISE/03-EDGE-CASES/06-race_condition_hunter.md`_

**Piège** : `null` vs `undefined` : fige une convention d'équipe dès le départ, sinon ce sont des débats sans fin. Une clé `__proto__` dans un JSON qu'on vient de parser peut réécrire toute la chaîne de prototypes (ça rejoint la pollution de prototype du module `03-PILOTAGE/04-SECURITY`).
...
## 05-MAITRISE/03-EDGE-CASES · IA Agents & Autonomy
...
_Fichier : `05-MAITRISE/03-EDGE-CASES/02_verifiable_specifications.md`_
...
**Pont** : même échéance de péremption que le module `04-EPREUVE/04-BIG-APP-SNOOP` (2028) : ce qui reste vrai des deux modules, c'est le principe de garder le contrôle, pas l'outil du moment.

---

## 02-CONSTRUCTION/02-MINI-PROJECTS · Mini-Projets
...
_Fichier : `02-CONSTRUCTION/02-MINI-PROJECTS/97-templates/04-POSTMORTEM_TEMPLATE.md`_
...
## 05-MAITRISE/06-ANNEXES · Annexes
...
_Fichier : `05-MAITRISE/06-ANNEXES/05-when_not_to_code.md`_
...
**Pont** : les fichiers PERISSABILITE et PONTS*INTER_MODULES sont tes deux cartes à garder ouvertes en permanence. Elles remplacent la table des matières.
\_Fichiers : `05-MAITRISE/06-ANNEXES/18-PERISSABILITE.md`, `05-MAITRISE/06-ANNEXES/99A-PONT.md`*

---

## 05-MAITRISE/07-TOOLS · Tools
...
_Fichier : `../05-MAITRISE/07-TOOLS/01-00-why-tools.md`_
...
## Je deviens quoi après ce parcours, concrètement

Pas du rêve, pas du recrutement déguisé : ce que le guide carrière du repo lui-même documente (`05-MAITRISE/06-ANNEXES/16_career/02-guide.md`), condensé à l'essentiel.
...
24-26  DB, Scalability, Observability -> tu tiens en production,
                    pas juste en dev
23,29  IA-Native, Agents      -> tu utilises l'IA sans t'y noyer
...
::::::::::::::::::::::::::::::::
 ...
 Accès    : direct, c'est le cœur des modules `02-CONSTRUCTION/19-API-CRAFT` a `03-PILOTAGE/05-OBSERVABILITY`
...
DEVOPS / CLOUD  : ajoute Docker/Kubernetes/Terraform en profondeur
              (05-MAITRISE/02-SCALABILITY + 03-PILOTAGE/05-OBSERVABILITY sont ton point de départ,
               pas ton point d'arrivée)

AI ENGINEER   : ajoute Python + un framework de Machine Learning
              (04-EPREUVE/04-BIG-APP-SNOOP te donne le réflexe de validation,
               pas la stack ML elle-même)

CYBERSÉCURITÉ  : ajoute Kali/Burp Suite/du pentest actif (des tests
              d'intrusion volontaires)
              (03-PILOTAGE/04-SECURITY te donne les fondations défensives,
               pas l'attaque)
```
...
La différence entre junior et senior n'est pas le nombre de langages connus. C'est la capacité à voir ce qui va mal **avant** que ça arrive : exactement ce que les module `01-CADRAGE/03-DEBUGGING` (Debugging), 25 (Scalability) et 30 (Mini-Projets avec POSTMORTEM) construisent, module après module.
...
+------------------------------------------------------------------+
| Pensée algorithmique  -> module `02-CONSTRUCTION/07-ALGORITHMS`                  |
| Structures de données  -> module `02-CONSTRUCTION/06-DATA-STRUCTURES`                  |
| Réseaux et web     -> module `02-CONSTRUCTION/18-WEB-CONCEPTS`, 20, 21              |
| Débogage systématique  -> module `01-CADRAGE/03-DEBUGGING`                  |
| Bases de données    -> module `05-MAITRISE/01-DATABASES`                    |
| Sécurité de base    -> module `03-PILOTAGE/04-SECURITY`                    |
| Communication technique -> module `03-PILOTAGE/10-TEAM-CRAFT`                   |
| Apprendre en continu  -> module `04-EPREUVE/04-BIG-APP-SNOOP`, 29 (justement parce que  |
