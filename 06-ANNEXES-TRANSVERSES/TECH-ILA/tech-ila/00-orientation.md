...
Un backtick est donc un rappel volontaire, jamais un oubli. Et un chemin d'annexe s'écrit TOUJOURS préfixé de `05-MAITRISE/06_annexes/` : les sous-dossiers d'annexes ont leur propre numérotation, indépendante de celle des 32 modules.
