...
C'est une **composition de fonctions** ([03_composition.md](../../../02-CONSTRUCTION/09_functional_js/03_composition.md)) où chaque maillon peut court-circuiter ou passer la main. Si tu as compris la composition et le pattern Chain of Responsibility (`12_design_patterns/`), tu as compris Express en dix minutes.
