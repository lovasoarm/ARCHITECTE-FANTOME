...
<a id="mod-00"></a>**Prélude : `00-SOCLE/01_getting_started/` et `00-SOCLE/03_referentiel/`.**
...
<a id="mod-01"></a>**01 · `00-SOCLE/04_fundamentals/`.** Portée, référence, mutation, coercition :
...
<a id="mod-02"></a>**02 · `00-SOCLE/05_problem_solving/`.** Clarifier une demande floue avant de coder
...
<a id="mod-03"></a>**03 · `01-CADRAGE/02_async/`.** Ordre d'exécution, microtâches, annulation,
...
<a id="mod-04"></a>**04 · `01-CADRAGE/03_debugging/`.** Reproduire avant de corriger, formuler une
...
<a id="mod-05"></a>**05 · `01-CADRAGE/04_error_handling/`.** Une erreur est une donnée qui voyage :
...
<a id="mod-06"></a>**06 · `02-CONSTRUCTION/03_testing/`.** Voir la fiche outillage en
...
<a id="mod-07"></a>**07 · `02-CONSTRUCTION/04_math_basics/`.** Verdict global : indirect, avec des
...
<a id="mod-08"></a>**08 · `02-CONSTRUCTION/05_memory_performance/`.** Mesurer avant d'optimiser, comprendre
...
<a id="mod-09-10"></a>**09-10 · `02-CONSTRUCTION/06_data_structures/` et `02-CONSTRUCTION/07_algorithms/`.** Indirect
...
<a id="mod-11-12"></a>**11-12 · `02-CONSTRUCTION/09_functional_js/` et `02-CONSTRUCTION/10_design_patterns/`.** Pureté,
...
<a id="mod-13"></a>**13 · `02-CONSTRUCTION/11_refactoring/`.** SOLID, code smells, et la règle la plus
...
<a id="mod-14"></a>**14 · `02-CONSTRUCTION/12_typescript/`.** Voir
...
<a id="mod-15"></a>**15 · `02-CONSTRUCTION/13_runtime_env/`.** Node vs navigateur, streams, CommonJS vs
...
<a id="mod-16"></a>**16 · `02-CONSTRUCTION/14_architecture_patterns/`.** Le domaine ne dépend de rien ;
...
<a id="mod-17"></a>**17 · `02-CONSTRUCTION/18_web_concepts/`.** HTTP/REST, cache, état et flux de données,
...
<a id="mod-18"></a>**18 · `02-CONSTRUCTION/17_oop_js/`.** Héritage contre composition : React a tranché en
...
<a id="mod-19"></a>**19 · `03-PILOTAGE/02_web_inclusive/`.** Accessibilité (i18n compris) : un instant
...
<a id="mod-20"></a>**20 · `04-EPREUVE/03_realtime/`.** WebSocket, SSE, WebRTC : une décision de
...
<a id="mod-21"></a>**21 · `02-CONSTRUCTION/19_api_craft/`.** Une API est un contrat public : ses erreurs en
...
<a id="mod-22"></a>**22 · `03-PILOTAGE/04_security/`.** Ton code n'est pas ta surface d'attaque : tes
...
<a id="mod-23"></a>**23 · `04-EPREUVE/04_ai_native_dev/`.** Le code généré est une proposition, pas un
...
<a id="mod-24"></a>**24 · `05-MAITRISE/01_databases/`.** Le modèle de données survit à tous les
...
<a id="mod-25"></a>**25 · `05-MAITRISE/02_scalability/`.** Le réseau échoue, la latence n'est pas
...
<a id="mod-26"></a>**26 · `03-PILOTAGE/05_observability/`.** En production, pas de point d'arrêt : ce
...
<a id="mod-27"></a>**27 · `03-PILOTAGE/10_team_craft/`.** Une décision non écrite n'existe pas. Un ADR
...
<a id="mod-28"></a>**28 · `05-MAITRISE/03_edge_cases/`.** `0.1 + 0.2 !== 0.3` n'est pas une bizarrerie
...
<a id="mod-29"></a>**29 · `05-MAITRISE/04_ai_agents_and_autonomy/`.** Un agent exécute ce qui est
...
<a id="mod-30-31"></a>**30-31 · `02-CONSTRUCTION/02_mini_projects/` et `05-MAITRISE/06_annexes/`.** Pas de fiche par
...
sous-dossier au moment où TECH-ILA en a besoin : `05-MAITRISE/06_annexes/23_reading/`,
`05-MAITRISE/06_annexes/29_toolchain/` et `05-MAITRISE/06_annexes/30_transferability/` sont les plus réutilisés.
Attention au piège de lecture : les sous-dossiers d'annexes ont leur propre numérotation,
indépendante de celle des 32 modules. `05-MAITRISE/06_annexes/23_reading/` n'a rien à voir avec
`04-EPREUVE/04_ai_native_dev/`. Dans TECH-ILA, un chemin d'annexe s'écrit TOUJOURS préfixé de
`05-MAITRISE/06_annexes/`.

<a id="mod-32"></a>**32 · `05-MAITRISE/07_tools/`.** Construire soi-même l'outil minimal qu'on utilise
...
| ----------------------------------------------------- | ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| React : mon `setInterval` compte jusqu'à 1            | closure figée                             | [`00-SOCLE/04_fundamentals/02_scope/02_closure_trap.md`](../../../00-SOCLE/04_fundamentals/02_scope/02_closure_trap.md)                                                                                                                               | lire un tableau de dépendances au lieu de le deviner           |
| React : la mauvaise réponse s'affiche                 | race condition                            | [`05-MAITRISE/03_edge_cases/05_race_condition_hunter.md`](../../../05-MAITRISE/03_edge_cases/05_race_condition_hunter.md), [`01-CADRAGE/02_async/03_async_await/02c_abort_controller.md`](../../../01-CADRAGE/02_async/03_async_await/02c_abort_controller.md)                             | annuler une requête obsolète                                   |
| React : muter l'état ne rerend pas                    | identité de référence                     | [`00-SOCLE/04_fundamentals/01_variables/02_reference_chaos.md`](../../../00-SOCLE/04_fundamentals/01_variables/02_reference_chaos.md)                                                                                                                 | expliquer pourquoi l'immutabilité est une contrainte technique |
| Node : `heap out of memory`                           | tout chargé en mémoire                    | [`02-CONSTRUCTION/13_runtime_env/02_streams_buffers.md`](../../../02-CONSTRUCTION/13_runtime_env/02_streams_buffers.md), [`02-CONSTRUCTION/05_memory_performance/04_profiling/`](../../../02-CONSTRUCTION/05_memory_performance/04_profiling)                                                         | passer en streaming et le prouver                              |
| Node : l'API entière ralentit                         | event loop bloquée                        | [`01-CADRAGE/02_async/04_event_loop/`](../../../01-CADRAGE/02_async/04_event_loop)                                                                                                                                                                       | déporter le CPU en worker                                      |
| Node : le client attend indéfiniment                  | rejet async non attrapé                   | [`01-CADRAGE/04_error_handling/04_async_error_traps.md`](../../../01-CADRAGE/04_error_handling/04_async_error_traps.md)                                                                                                                                   | fermer tous les chemins d'erreur                               |
| Express : mon middleware d'erreur ne s'exécute jamais | promesse rejetée hors chaîne              | [`01-CADRAGE/04_error_handling/03_error_propagation.md`](../../../01-CADRAGE/04_error_handling/03_error_propagation.md)                                                                                                                                   | envelopper les handlers async                                  |
| NestJS : `can't resolve dependencies`                 | graphe d'injection                        | [`02-CONSTRUCTION/14_architecture_patterns/02_solid_principles.md`](../../../02-CONSTRUCTION/14_architecture_patterns/02_solid_principles.md)                                                                                                                       | lire un graphe de modules                                      |
| NestJS : données d'un client vues par un autre        | état dans un singleton                    | [`00-SOCLE/04_fundamentals/02_scope/02_closure_trap.md`](../../../00-SOCLE/04_fundamentals/02_scope/02_closure_trap.md), [`02-CONSTRUCTION/10_design_patterns/01_creational/02_singleton_pattern.md`](../../../02-CONSTRUCTION/10_design_patterns/01_creational/02_singleton_pattern.md) | placer l'état au bon endroit                                   |
| SQL : rapide en dev, lent en prod                     | plan d'exécution / index                  | [`02-CONSTRUCTION/06_data_structures/06_bst/`](../../../02-CONSTRUCTION/06_data_structures/06_bst), [`02-CONSTRUCTION/05_memory_performance/03_complexity/`](../../../02-CONSTRUCTION/05_memory_performance/03_complexity)                                                                           | lire un `EXPLAIN ANALYZE`                                      |
| SQL : doublons malgré la vérification                 | lecture-modification-écriture concurrente | [`05-MAITRISE/03_edge_cases/05_race_condition_hunter.md`](../../../05-MAITRISE/03_edge_cases/05_race_condition_hunter.md)                                                                                                                                   | poser une contrainte d'unicité en base                         |
| SQL : montants faux au centime                        | flottants                                 | [`05-MAITRISE/03_edge_cases/02_floating_point.md`](../../../05-MAITRISE/03_edge_cases/02_floating_point.md)                                                                                                                                                 | utiliser un type décimal                                       |
| Redis : la base s'effondre à l'expiration             | ruée sur le cache                         | [`02-CONSTRUCTION/18_web_concepts/04_caching_strategies.md`](../../../02-CONSTRUCTION/18_web_concepts/04_caching_strategies.md)                                                                                                                                     | jitter, verrou, stale-while-revalidate                         |
| File : le job s'exécute deux fois                     | livraison au moins une fois               | [`05-MAITRISE/02_scalability/07_message_queues.md`](../../../05-MAITRISE/02_scalability/07_message_queues.md)                                                                                                                                               | rendre le handler idempotent                                   |
| Docker : `permission denied`                          | uid / permissions                         | [`00-SOCLE/01_getting_started/02b_shell_survival.md`](../../../00-SOCLE/01_getting_started/02b_shell_survival.md)                                                                                                                                       | lire des permissions Unix                                      |
| Docker : requêtes coupées au déploiement              | `SIGTERM` ignoré                          | [`02-CONSTRUCTION/13_runtime_env/04_process_env_argv.md`](../../../02-CONSTRUCTION/13_runtime_env/04_process_env_argv.md)                                                                                                                                           | implémenter un arrêt gracieux                                  |
| CI : le test échoue 1 fois sur 20                     | test flaky                                | [`01-CADRAGE/03_debugging/07_flaky_bugs.md`](../../../01-CADRAGE/03_debugging/07_flaky_bugs.md)                                                                                                                                                           | isoler la source de non-déterminisme                           |
| Prod : moyenne verte, clients furieux                 | p99 vs moyenne                            | [`03-PILOTAGE/05_observability/04_metrics_alerting.md`](../../../03-PILOTAGE/05_observability/04_metrics_alerting.md)                                                                                                                                       | raisonner en percentiles                                       |
| Prod : erreur illisible dans la trace                 | source maps absentes                      | [`03-PILOTAGE/05_observability/07_prod_stack_trace_drill.md`](../../../03-PILOTAGE/05_observability/07_prod_stack_trace_drill.md)                                                                                                                           | remonter à la ligne d'origine                                  |
| Python : ma closure ne modifie rien                   | `nonlocal`                                | [`00-SOCLE/04_fundamentals/02_scope/`](../../../00-SOCLE/04_fundamentals/02_scope)                                                                                                                                                                   | transférer le mécanisme entre langages                         |
| Java : `LazyInitializationException` / N+1            | chargement paresseux                      | [`05-MAITRISE/01_databases/05_db_in_js.md`](../../../05-MAITRISE/01_databases/05_db_in_js.md), [`02-CONSTRUCTION/05_memory_performance/03_complexity/`](../../../02-CONSTRUCTION/05_memory_performance/03_complexity)                                                                         | reconnaître le N+1 dans tout ORM                               |
| C# : dictionnaire corrompu sous charge                | parallélisme réel                         | [`01-CADRAGE/02_async/07_shared_memory_concurrency.md`](../../../01-CADRAGE/02_async/07_shared_memory_concurrency.md)                                                                                                                                     | comprendre ce que JS t'épargnait                               |
| IA : le code semble correct et casse en prod          | chemins d'erreur absents                  | [`04-EPREUVE/04_ai_native_dev/03_validate_ai_output.md`](../../../04-EPREUVE/04_ai_native_dev/03_validate_ai_output.md)                                                                                                                                   | exiger une preuve avant de faire confiance                     |
