...
Prérequis MyFunnyJS : modules `04-EPREUVE/04_ai_native_dev/` et `05-MAITRISE/04_ai_agents_and_autonomy/` complets. Ce document ne les répète pas : il les applique aux technologies.
...
- **Spécification vérifiable** avant lancement (`05-MAITRISE/04_ai_agents_and_autonomy/02_verifiable_specifications.md`) : sans critère d'arrêt, un agent optimise le plausible.
...
**Legacy.** Le code ancien contient des décisions dont le contexte a disparu. Un `if` bizarre est parfois un correctif de bug de 2019 pour un client qui existe encore. Supprimer ce que tu ne comprends pas est la façon la plus rapide de créer un incident (`02-CONSTRUCTION/11_refactoring/06_do_not_touch_before_explain.md`).
...
> **Réutilise** : `00-SOCLE/04_fundamentals/02_scope/02_closure_trap.md`
...
> **Réutilise** : `02-CONSTRUCTION/13_runtime_env/04_process_env_argv.md`
...
> **Réutilise** : `02-CONSTRUCTION/14_architecture_patterns/02_solid_principles.md`
