...
1. **Vérifie Node** dans un terminal : `node -v`. Règle officielle : **Node >= 22 recommande (voir `.nvmrc` = v22, fichier pédagogique visible), tout code du curriculum doit tourner aussi sur Node 20 LTS**. Detail : [`NODE_VERSION.md`](NODE_VERSION.md). Sinon, ouvre `00-SOCLE/01_getting_started/01_install.md` et reviens ici.
