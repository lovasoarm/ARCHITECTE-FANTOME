...
> **Tu viens de** : 06-niveau-6-IA.md
> **Tu dois déjà savoir** : les six niveaux de TECH-ILA, au moins en survol
> **Ensuite** : 08-IA-exercices-marche-audit.md

# Cartes du parcours ↔ technologies
...
Le sharding répartit les données selon une clé afin de distribuer stockage et charge.
...
> Document historique : les comptages ci-dessous décrivent l'ancienne numérotation, pas le fil actuel.

Cette annexe se consulte, elle ne se lit pas. Tu ne dois jamais l'ouvrir en entier : tu
arrives ici avec un symptôme (une techno qui te résiste, un module du parcours que tu viens de
finir) et tu repars avec un lien. Les fiches complètes : coût, durée de vie, exemple qui
casse : sont dans les fichiers de 01-CADRAGE à 06. Ici, tu trouves seulement le pont entre les
54 modules pédagogiques directs du parcours et le monde technologique qui les réutilise.

**Point de couplage le plus fragile du document.** Cette carte est le seul endroit où TECH-ILA
dépend de l'arborescence exacte du parcours. Si un lien casse, c'est ici en premier : un fichier
le parcours déplacé sans répercussion ici produit un lien mort. Contrat de dépendance : TECH-ILA
référence le parcours à l'état de la dernière revue trimestrielle (voir le rituel de recomptage du
[README](../README.md)), et un fichier du parcours référencé ici ne se déplace pas sans que le
déplacement soit répercuté dans le même changement. Le point de contrôle est le lien, pas le fichier.

Deux entrées possibles :

- **Section 10** : tu sors d'un module du parcours, tu veux savoir où ça sert.
- **Section 11** : tu es bloqué sur une techno, tu veux savoir quel mécanisme du parcours relire.
...
22 [Security](#mod-22) · 23 [IA native dev](#mod-23) · 24 [Databases](#mod-24) ·
25 [Scalability](#mod-25) · 26 [Observability](#mod-26) · 27 [Team craft](#mod-27) ·
28 [Edge cases](#mod-28) · 29 [IA agents & autonomy](#mod-29) · 30-31
[Mini-projects & annexes](#mod-30-31) · 32 [Tools](#mod-32).

---

<a id="10-carte-du-parcours-technologies-module-par-module"></a>

## 10 : Carte du parcours → technologies, module par module
...
<a id="mod-00"></a>**Prélude : `00-SOCLE/01-GETTING-STARTED/` et `00-SOCLE/03-REFERENTIEL/`.**
Shell, Git, gestionnaires de paquets, hygiène de sécurité perso, grille intemporel/périssable :
le socle qu'on utilise sans le nommer, tous les jours, dans tout écosystème. `08-repetition_espacee.md`
...
<a id="mod-01"></a>**01 · `00-SOCLE/04-FUNDAMENTALS/`.** Portée, référence, mutation, coercition :
...
Technos : React, Node.js, NestJS, TypeScript, Python, Java/Spring : `02A-git_core.md` renvoie
directement à [4.2](03-niveau-1-socle.md#42-git-et-github).

<a id="mod-02"></a>**02 · `00-SOCLE/05-PROBLEM-SOLVING/`.** Clarifier une demande floue avant de coder
...
<a id="mod-03"></a>**03 · `01-CADRAGE/02-ASYNC/`.** Ordre d'exécution, microtâches, annulation,
...
<a id="mod-04"></a>**04 · `01-CADRAGE/03-DEBUGGING/`.** Reproduire avant de corriger, formuler une
...
<a id="mod-05"></a>**05 · `01-CADRAGE/04-ERROR-HANDLING/`.** Une erreur est une donnée qui voyage :
...
<a id="mod-06"></a>**06 · `02-CONSTRUCTION/03-TESTING/`.** Voir la fiche outillage en
[4.8](03-niveau-1-socle.md#48-testing-en-conditions-réelles). Le point qui ne bouge
...
<a id="mod-07"></a>**07 · `02-CONSTRUCTION/04-MATH-BASICS/`.** Verdict global : indirect, avec des
...
<a id="mod-08"></a>**08 · `02-CONSTRUCTION/05-MEMORY-PERFORMANCE/`.** Mesurer avant d'optimiser, comprendre
...
<a id="mod-09-10"></a>**09-10 · `02-CONSTRUCTION/06-DATA-STRUCTURES/` et `02-CONSTRUCTION/07-ALGORITHMS/`.** Indirect
...
<a id="mod-11-12"></a>**11-12 · `02-CONSTRUCTION/09-FUNCTIONAL-JS/` et `02-CONSTRUCTION/10-DESIGN-PATTERNS/`.** Pureté,
...
<a id="mod-13"></a>**13 · `02-CONSTRUCTION/11-REFACTORING/`.** SOLID, code smells, et la règle la plus
...
<a id="mod-14"></a>**14 · `02-CONSTRUCTION/12-TYPESCRIPT/`.** Voir
[4.5](03-niveau-1-socle.md#45-typescript-en-conditions-réelles). Génériques et unions
...
<a id="mod-15"></a>**15 · `02-CONSTRUCTION/13-RUNTIME-ENV/`.** Node vs navigateur, streams, CommonJS vs
...
<a id="mod-16"></a>**16 · `02-CONSTRUCTION/14-ARCHITECTURE-PATTERNS/`.** Le domaine ne dépend de rien ;
...
<a id="mod-17"></a>**17 · `02-CONSTRUCTION/18-WEB-CONCEPTS/`.** HTTP/REST, cache, état et flux de données,
...
<a id="mod-18"></a>**18 · `02-CONSTRUCTION/17-OOP-JS/`.** Héritage contre composition : React a tranché en
...
<a id="mod-19"></a>**19 · `03-PILOTAGE/02-WEB-INCLUSIVE/`.** Accessibilité (i18n compris) : un instant
...
<a id="mod-20"></a>**20 · `04-EPREUVE/03-REALTIME/`.** WebSocket, SSE, WebRTC : une décision de
...
<a id="mod-21"></a>**21 · `02-CONSTRUCTION/19-API-CRAFT/`.** Une API est un contrat public : ses erreurs en
...
<a id="mod-22"></a>**22 · `03-PILOTAGE/04-SECURITY/`.** Ton code n'est pas ta surface d'attaque : tes
...
<a id="mod-23"></a>**23 · `04-EPREUVE/04-BIG-APP-SNOOP/`.** Le code généré est une proposition, pas un
...
<a id="mod-24"></a>**24 · `05-MAITRISE/01-DATABASES/`.** Le modèle de données survit à tous les
...
<a id="mod-25"></a>**25 · `05-MAITRISE/02-SCALABILITY/`.** Le réseau échoue, la latence n'est pas
...
<a id="mod-26"></a>**26 · `03-PILOTAGE/05-OBSERVABILITY/`.** En production, pas de point d'arrêt : ce
...
<a id="mod-27"></a>**27 · `03-PILOTAGE/10-TEAM-CRAFT/`.** Une décision non écrite n'existe pas. Un ADR
...
<a id="mod-28"></a>**28 · `05-MAITRISE/03-EDGE-CASES/`.** `0.1 + 0.2 !== 0.3` n'est pas une bizarrerie
...
<a id="mod-29"></a>**29 · `05-MAITRISE/03-EDGE-CASES/`.** Un agent exécute ce qui est
...
<a id="mod-30-31"></a>**30-31 · `02-CONSTRUCTION/02-MINI-PROJECTS/` et `05-MAITRISE/06-ANNEXES/`.** Pas de fiche par
...
sous-dossier au moment où TECH-ILA en a besoin : `05-MAITRISE/06-ANNEXES/23_reading/`,
`05-MAITRISE/06-ANNEXES/29_toolchain/` et `05-MAITRISE/06-ANNEXES/30_transferability/` sont les plus réutilisés.
Attention au piège de lecture : les sous-dossiers d'annexes ont leur propre numérotation,
indépendante de celle des 54 modules pédagogiques directs. `05-MAITRISE/06-ANNEXES/23_reading/` n'a rien à voir avec
`04-EPREUVE/04-BIG-APP-SNOOP/`. Dans TECH-ILA, un chemin d'annexe s'écrit TOUJOURS préfixé de
`05-MAITRISE/06-ANNEXES/`.

<a id="mod-32"></a>**32 · `05-MAITRISE/07-TOOLS/`.** Construire soi-même l'outil minimal qu'on utilise
...
**Seuil franchi.** Les 54 modules pédagogiques directs sont cartographiés. Tu ne cherches plus « où réviser » : tu
pars du symptôme technologique et tu remontes au mécanisme. C'est l'objet de la section
suivante.

---

<a id="11-carte-inverse-technologie-fichiers-du-parcours"></a>

## 11 : Carte inverse : technologie → fichiers du parcours
...
Technologie
    ↓ Mécanisme utilisé
    ↓ Fichier le parcours à relire
    ↓ Compétence opérationnelle
```

| Symptôme rencontré                                    | Mécanisme réel                            | Fichier à relire                                                                                                                                                                                                                                                                                  | Ce que tu sauras faire                                         |
| ----------------------------------------------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| React : mon `setInterval` compte jusqu'à 1            | closure figée                             | [`00-SOCLE/04-FUNDAMENTALS/02_scope/04-closure_trap.md`](../../../00-SOCLE/04-FUNDAMENTALS/02_scope/04-closure_trap.md)                                                                                                                                                                           | lire un tableau de dépendances au lieu de le deviner           |
| React : la mauvaise réponse s'affiche                 | race condition                            | [`../../../05-MAITRISE/03-EDGE-CASES/06-race_condition_hunter.md`](../../../05-MAITRISE/03-EDGE-CASES/06-race_condition_hunter.md), [`01-CADRAGE/02-ASYNC/03_async_await/05-c_abort_controller.md`](../../../01-CADRAGE/02-ASYNC/03_async_await/05-c_abort_controller.md)                         | annuler une requête obsolète                                   |
| React : muter l'état ne rerend pas                    | identité de référence                     | [`00-SOCLE/04-FUNDAMENTALS/01_variables/07-reference_chaos.md`](../../../00-SOCLE/04-FUNDAMENTALS/01_variables/07-reference_chaos.md)                                                                                                                                                             | expliquer pourquoi l'immutabilité est une contrainte technique |
| Node : `heap out of memory`                           | tout chargé en mémoire                    | [`02-CONSTRUCTION/13-RUNTIME-ENV/03-streams_buffers.md`](../../../02-CONSTRUCTION/13-RUNTIME-ENV/03-streams_buffers.md), [`02-CONSTRUCTION/05-MEMORY-PERFORMANCE/04_profiling/`](../../../02-CONSTRUCTION/05-MEMORY-PERFORMANCE/04_profiling/)                                                    | passer en streaming et le prouver                              |
| Node : l'API entière ralentit                         | event loop bloquée                        | [`01-CADRAGE/02-ASYNC/04_event_loop/`](../../../01-CADRAGE/02-ASYNC/04_event_loop/)                                                                                                                                                                                                               | déporter le CPU en worker                                      |
| Node : le client attend indéfiniment                  | rejet async non attrapé                   | [`01-CADRAGE/04-ERROR-HANDLING/05-async_error_traps.md`](../../../01-CADRAGE/04-ERROR-HANDLING/05-async_error_traps.md)                                                                                                                                                                           | fermer tous les chemins d'erreur                               |
| Express : mon middleware d'erreur ne s'exécute jamais | promesse rejetée hors chaîne              | [`01-CADRAGE/04-ERROR-HANDLING/04-error_propagation.md`](../../../01-CADRAGE/04-ERROR-HANDLING/04-error_propagation.md)                                                                                                                                                                           | envelopper les handlers async                                  |
| NestJS : `can't resolve dependencies`                 | graphe d'injection                        | [`02-CONSTRUCTION/14-ARCHITECTURE-PATTERNS/02_solid_principles.md`](../../../02-CONSTRUCTION/14-ARCHITECTURE-PATTERNS/03-solid_principles.md)                                                                                                                                                     | lire un graphe de modules                                      |
| NestJS : données d'un client vues par un autre        | état dans un singleton                    | [`00-SOCLE/04-FUNDAMENTALS/02_scope/04-closure_trap.md`](../../../00-SOCLE/04-FUNDAMENTALS/02_scope/04-closure_trap.md), [`../../../02-CONSTRUCTION/10-DESIGN-PATTERNS/01_creational/03-singleton_pattern.md`](../../../02-CONSTRUCTION/10-DESIGN-PATTERNS/01_creational/03-singleton_pattern.md) | placer l'état au bon endroit                                   |
| SQL : rapide en dev, lent en prod                     | plan d'exécution / index                  | [`02-CONSTRUCTION/06-DATA-STRUCTURES/06_bst/`](../../../02-CONSTRUCTION/06-DATA-STRUCTURES/06_bst/), [`02-CONSTRUCTION/05-MEMORY-PERFORMANCE/03_complexity/`](../../../02-CONSTRUCTION/05-MEMORY-PERFORMANCE/03_complexity/)                                                                      | lire un `EXPLAIN ANALYZE`                                      |
| SQL : doublons malgré la vérification                 | lecture-modification-écriture concurrente | [`../../../05-MAITRISE/03-EDGE-CASES/06-race_condition_hunter.md`](../../../05-MAITRISE/03-EDGE-CASES/06-race_condition_hunter.md)                                                                                                                                                                | poser une contrainte d'unicité en base                         |
| SQL : montants faux au centime                        | flottants                                 | [`../../../05-MAITRISE/03-EDGE-CASES/03-floating_point.md`](../../../05-MAITRISE/03-EDGE-CASES/03-floating_point.md)                                                                                                                                                                              | utiliser un type décimal                                       |
| Redis : la base s'effondre à l'expiration             | ruée sur le cache                         | [`02-CONSTRUCTION/18-WEB-CONCEPTS/05-caching_strategies.md`](../../../02-CONSTRUCTION/18-WEB-CONCEPTS/05-caching_strategies.md)                                                                                                                                                                   | jitter, verrou, stale-while-revalidate                         |
| File : le job s'exécute deux fois                     | livraison au moins une fois               | [`05-MAITRISE/02-SCALABILITY/08-message_queues.md`](../../../05-MAITRISE/02-SCALABILITY/08-message_queues.md)                                                                                                                                                                                     | rendre le handler idempotent                                   |
| Docker : `permission denied`                          | uid / permissions                         | [`../../../00-SOCLE/01-GETTING-STARTED/04-shell_survival.md`](../../../00-SOCLE/01-GETTING-STARTED/04-shell_survival.md)                                                                                                                                                                          | lire des permissions Unix                                      |
| Docker : requêtes coupées au déploiement              | `SIGTERM` ignoré                          | [`02-CONSTRUCTION/13-RUNTIME-ENV/05-process_env_argv.md`](../../../02-CONSTRUCTION/13-RUNTIME-ENV/05-process_env_argv.md)                                                                                                                                                                         | implémenter un arrêt gracieux                                  |
| CI : le test échoue 1 fois sur 20                     | test flaky                                | [`../../../01-CADRAGE/03-DEBUGGING/08-flaky_bugs.md`](../../../01-CADRAGE/03-DEBUGGING/08-flaky_bugs.md)                                                                                                                                                                                          | isoler la source de non-déterminisme                           |
| Prod : moyenne verte, clients furieux                 | p99 vs moyenne                            | [`03-PILOTAGE/05-OBSERVABILITY/05-metrics_alerting.md`](../../../03-PILOTAGE/05-OBSERVABILITY/05-metrics_alerting.md)                                                                                                                                                                             | raisonner en percentiles                                       |
| Prod : erreur illisible dans la trace                 | source maps absentes                      | [`03-PILOTAGE/05-OBSERVABILITY/08-prod_stack_trace_drill.md`](../../../03-PILOTAGE/05-OBSERVABILITY/08-prod_stack_trace_drill.md)                                                                                                                                                                 | remonter à la ligne d'origine                                  |
| Python : ma closure ne modifie rien                   | `nonlocal`                                | [`00-SOCLE/04-FUNDAMENTALS/02_scope/`](../../../00-SOCLE/04-FUNDAMENTALS/02_scope/)                                                                                                                                                                                                               | transférer le mécanisme entre langages                         |
| Java : `LazyInitializationException` / N+1            | chargement paresseux                      | [`05-MAITRISE/01-DATABASES/06-db_in_js.md`](../../../05-MAITRISE/01-DATABASES/06-db_in_js.md), [`02-CONSTRUCTION/05-MEMORY-PERFORMANCE/03_complexity/`](../../../02-CONSTRUCTION/05-MEMORY-PERFORMANCE/03_complexity/)                                                                            | reconnaître le N+1 dans tout ORM                               |
| C# : dictionnaire corrompu sous charge                | parallélisme réel                         | [`01-CADRAGE/02-ASYNC/05-shared_memory_concurrency.md`](../../../01-CADRAGE/02-ASYNC/05-shared_memory_concurrency.md)                                                                                                                                                                             | comprendre ce que JS t'épargnait                               |
...
← 06 · IA · [Sommaire](../README.md) · 08 · Exercices & audit marché →
