...
Traite le changement de spec imposé au capstone (`04-EPREUVE/05-CAPSTONE-ARENA/05-changement-de-spec.md`).
...
| Coût      | 14 jours-personne, plus 96 €/mois d'infrastructure supplémentaire                         | chiffrage d'équipe du 03/06 ; ligne cloud issue de `PREUVES/06A-BUDGET-CLOUD.md`, palier 10 000, relevé 03/02 |
