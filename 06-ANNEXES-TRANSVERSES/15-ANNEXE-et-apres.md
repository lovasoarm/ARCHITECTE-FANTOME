...
inutile. Relis `../02-CONSTRUCTION/15-ARCHI-LAB/05-choosing-architecture.md` chaque fois que tu sens venir un framework
maison.
...
d'exploration du module `04-EPREUVE/04-BIG-APP-SNOOP`**, produit sur un dépôt réel que tu n'as pas écrit
([95-challenge.md](../04-EPREUVE/04-BIG-APP-SNOOP/95-challenge.md)). Traite-le comme une pièce de
portfolio à part entière, pas comme un exercice interne.

| Pièce                                                          | Ce qu'elle prouve                                                                 | Ce qu'elle ne prouve pas                              |
| -------------------------------------------------------------- | --------------------------------------------------------------------------------- | ----------------------------------------------------- |
| Projet fil rouge (de `01-CADRAGE/01-PROBLEM-HUNT` au capstone) | tu conduis un projet du besoin flou à la livraison, et tu assumes tes décisions   | que tu sais entrer dans du code que tu n'as pas écrit |
| Rapport d'exploration (module `04-EPREUVE/04-BIG-APP-SNOOP`)   | tu cartographies 50 000 lignes inconnues en 3 h et tu reconstitues des intentions | que tu sais construire de zéro                        |
| `TRANSFERT.md` (module `05-MAITRISE/05-DAY-TO-LEGEND`)         | tes réflexes survivent au changement d'écosystème                                 | rien de plus : c'est une preuve ciblée                |
...
mon-parcours-architecte/
  ...
  01-02-CAHIER-DES-CHARGES.md    le besoin, les non-objectifs, les métriques de succès
  ...
  06-rapport-exploration/   le rapport du module `04-EPREUVE/04-BIG-APP-SNOOP`, sur un dépôt que tu n'as pas écrit
  07-TRANSFERT.md           la preuve de transfert du module `05-MAITRISE/05-DAY-TO-LEGEND`
